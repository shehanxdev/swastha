...
class DrugListUpdate extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loaded: true,
                                ...
                                <>
                                    <div style={{ width: 100 }}>
                                        <TextValidator
                                            ...
                                            InputLabelProps={{ shrink: false }}
                                            value={
                                                this.state.data[dataIndex].ward
                                            }
                                            type="number"
                                            variant="outlined"
                                            size="small"
                            ...
                            return (
                                <Button
                                    onClick={() => {
                                        ...
                                        } else if (this.state.data[dataIndex].quantity < 0){  
                                            this.setState({
                                                alert: true,
                                                message: 'Balance Update cannot be a negative value',
                                                severity: 'error',
                                            })
                                        }
                                        else {
        ...
        let data = {
            ...
            balanced_quantity:
                (parseInt(this.state.data[dataIndex].quantity) -
                    ...
                    parseInt(this.state.data[dataIndex].ward) -
                    parseInt(this.state.data[dataIndex].waste) +
                    parseInt(this.state.data[dataIndex].excess)).toString(), //row.balanced_quantity
