                                            ...
                                            endAdornment: (
                                                <InputAdornment position="end">
                                                    <IconButton
                                                        ...
                                                        size="small"
                                                        color="primary"
                                                        disabled={this.state.formData.to != null ? (this.state.data[tableMeta.rowIndex].Warehouse?.id != this.state.formData.to ? true : false) : false}
                                                    /* disabled={
                    ...
                    batch_list: [
                        {
                            ...
                            item_name: row?.ItemSnapBatch?.ItemSnap?.medium_description,//short_description
                            batch_no: row?.ItemSnapBatch?.batch_no,
                            item_batch_bin_id: row.id,
                            bin_id: row.bin_id,
                            unit_price: row?.ItemSnapBatch?.unit_price,
                            cost: Number(row?.ItemSnapBatch?.unit_price) * Number(row.allocated_quantity),
                ...
                <MainContainer>
                    <LoonsCard>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                            <Typography variant="h6" className="font-semibold"> Sales</Typography>
                            <LoonsButton
                                color='primary'
                                onClick={() => {
                                    ...
                                    <Grid item>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <SubTitle title={this.state.total_cost + this.state.service_charges} />
                                                </td>
                                            </tr>
                                        </table>
