...
import { LoonsTable, Charts, DatePicker, FilePicker, Button, ExcelToTable, LoonsSnackbar, SubTitle, Widget, DashboardComponent, CanvasDraw } from "app/components/LoonsLabComponents";
...
class ReportDashboard extends Component {
    ...
    async createNewDashboard() {
        ...
        var login_user_Hospital = await localStorageService.getItem('Login_user_Hospital');
    ...
    async getAllWidgetTypes() {
        let params = { limit: 1000, type: 'dashboard' }
    ...
    async getAllDashboards(clinic_id) {
        ...
        let params = { limit: 1000, clinic_id: clinic_id, owner_id: owner_id, type: user.type }
                ...
                <div className="px-2 py-2">
                    ...
                    <ValidatorForm>
                        <Grid container spacing={1}>
                            ...
                            <Grid item lg={9} md={9} sm={9} xs={9} className="px-5">
                            ...
                            <Grid item lg={3} md={3} sm={3} xs={3} className="px-5 flex justify-end ">
                                <WarehouseSelectComponent onChange={() => { this.changeWarehouse() }}></WarehouseSelectComponent>
...
export default withStyles(styleSheet)(ReportDashboard);
