...
class APDashboard extends Component {
    constructor(props) {
        super(props)
        this.state = {
            width: 250,
    ...
    async createNewDashboard() {
        ...
        var hospital_id = await localStorageService.getItem('main_hospital_id')
        ...
        if (res.status == 201) {
            ...
            this.setState(
                ...
                () => {
                    this.getAllDashboards(hospital_id)
                }
            )
        }
    }
    ...
    async getAllWidgetTypes() {
        let params = { limit: 1000, type: 'apDashboard' }
    ...
    async componentDidMount() {
        ...
        filterData.clinic_id = hospital_id
...
export default withStyles(styleSheet)(APDashboard)
