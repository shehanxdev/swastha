...
class Dashboard extends Component {
    ...
    async getAllDashboards(clinic_id) {
        ...
        let params = { limit: 1000, clinic_id: clinic_id }
        ...
        if (dashboards.status == 200) {
            ...
            this.setState({ all_Dashboard: dashboards.data.view.data })
        }
                        ...
                        <Grid container spacing={1}>
                           ...
                           <Grid item lg={6} md={6} sm={12} xs={12}>
                                ...
                                <TextValidator
                                    ...
                                    value={this.state.dashboardVariables.patient_id}
                                    type="text"
                                    variant="outlined"
                                    size="small"
                    ...
                    >
...

                        {
                            ...
                            this.state.selectedWidgets.map((item, i) => (
                                ...
                                <Paper className="border-radius-8 w-full" elevation={12} key={item.id.toString()} item  >
