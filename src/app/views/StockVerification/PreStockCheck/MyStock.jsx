...
import ItemStock from '../../../views/MSD_Medical_Supply_Assistant/ItemStock'
import DetailsView from '../../../views/MSD_Medical_Supply_Assistant/DetailsView'
import UnuserbleDrugs from '../../../views/MSD_Medical_Supply_Assistant/UnuserbleDrugs'
                        ...
                        <AppBar position="static" color="default" className="mb-4 mt-2">
                            <Grid item lg={12} md={12} xs={12}>
                                <Tabs style={{ minHeight: 39, height: 26 }}
                                    ...
                                    <Tab label={<span className="font-bold text-12">Unserviceable Drugs asdas</span>} />
