...
class PreStockCheck extends Component {
    constructor(props) {
        super(props)
        this.state = {
            buttonName: 'Filter',
                        ...
                        >
                            ...
                            <AppBar position="static" color="default">
                                <Tabs
                                    ...
                                    <Tab label="My Stock" onClick={() => { window.location.href = `/MyStock` }} />
                                    <Tab label="Order Details" onClick={() => { window.location.href = `/hospital-ordering/all-orders?type=Order` }} />
                                    <Tab label="Request Details" onClick={() => { window.location.href = `/msa_all_order/all-orders?type=Order` }} />
                                </Tabs>
                            </AppBar>
