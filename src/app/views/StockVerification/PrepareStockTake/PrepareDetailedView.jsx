...
import PrepareAddItem from "./PrepareAddItem"




class PrepareDetailedView extends Component {
    constructor(props) {
        super(props)
        this.state = {
            buttonName: 'Send For Approval',
            buttonName_1: 'Tally Report',
            buttonName_2: 'Finish',
            buttonName_3: 'Close',
            ...
            data: [
                { batch_no: <PackingDetails />, uom: "test1234", serviceable_quantity: 55, used_quantity: 34, expired_quantity: 6, Issued_quantity_and_status: 12, freeze_quantity: 67, },
                { batch_no: <PackingDetails />, uom: "test1234", serviceable_quantity: 55, used_quantity: 34, expired_quantity: 6, Issued_quantity_and_status: 12, freeze_quantity: 67, },
                { batch_no: <PackingDetails />, uom: "test1234", serviceable_quantity: 55, used_quantity: 34, expired_quantity: 6, Issued_quantity_and_status: 12, freeze_quantity: 67, },
                { batch_no: <PackingDetails />, uom: "test1234", serviceable_quantity: 55, used_quantity: 34, expired_quantity: 6, Issued_quantity_and_status: 12, freeze_quantity: 67, },
                { batch_no: <PackingDetails />, uom: "test1234", serviceable_quantity: 55, used_quantity: 34, expired_quantity: 6, Issued_quantity_and_status: 12, freeze_quantity: 67, },
                        ...
                        >
                            ...
                            <Grid className="flex mt-5">
                                ...
                                <Grid justifyContent="space-between" className=" w-full flex justify-end " item lg={12}
                                    ...
                                    <Button
                                        className="m-2 button-info"
                                        progress={false}
                                        type="submit"
                                        scrollToTop={true}

                                    >
                                        <span className="capitalize">{this.state.buttonName_3}</span>
                                    </Button>

                                    <Button
                                        className="m-2 button-primary"
                                        progress={false}
                                        type="submit"
                                        scrollToTop={true}
...
export default PrepareDetailedView