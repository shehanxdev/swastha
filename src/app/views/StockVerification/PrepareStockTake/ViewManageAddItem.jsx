...
import { Button, DatePicker } from 'app/components/LoonsLabComponents'
...
const ViewManageAddItem = ({ children, button, title }) => {
            ...
            <Dialog fullScreen open={open} onClose={handleClose}>
                ...
                <LoonsCard>
                    ...
                    <Grid className='flex justify-end mt-3' justifyContent="space-between">
                        ...
                        <DialogActions>
                            <Button onClick={handleClose} className='button-info'>Close</Button>

                        </DialogActions>


                        <DialogActions>
                            <Button onClick={handleClose} className='button-success'>Submit</Button>
...
export default ViewManageAddItem