...
class HeadStockTake extends Component {
    constructor(props) {
        super(props)
        this.state = {
            buttonName: 'close',
            ...
            data: [
                { item_code: "AB23", uom: "test1234", serviceable_quantity: 55, expired_quantity: 6, quality_failed_quantity: 12, freeze_quantity: 67, count_quantity: 112, remark: 'yes' },
                { item_code: "AB23", uom: "test1234", serviceable_quantity: 55, expired_quantity: 6, quality_failed_quantity: 12, freeze_quantity: 67, count_quantity: 112, remark: 'yes' },
                { item_code: "AB23", uom: "test1234", serviceable_quantity: 55, expired_quantity: 6, quality_failed_quantity: 12, freeze_quantity: 67, count_quantity: 112, remark: 'yes' },
                { item_code: "AB23", uom: "test1234", serviceable_quantity: 55, expired_quantity: 6, quality_failed_quantity: 12, freeze_quantity: 67, count_quantity: 112, remark: 'yes' },
                { item_code: "AB23", uom: "test1234", serviceable_quantity: 55, expired_quantity: 6, quality_failed_quantity: 12, freeze_quantity: 67, count_quantity: 112, remark: 'yes' },
                                    ...
                                    <Tooltip title="View">
                                        <IconButton
                                            ...
                                            onClick={() => {
                                                ...
                                                window.location.href = `/HeadPreStockDetailView`
                                            }}
                                            size="small"
                                            aria-label="view"
                                        >
