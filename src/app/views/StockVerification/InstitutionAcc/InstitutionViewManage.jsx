...
class InstitutionViewManage extends Component {
    constructor(props) {
        super(props)
        this.state = {
            buttonName: 'Filter',
            ...
            data: [
                { stock_take_no: "12", stock_take_date: "12/06/2023", warehouse_code: 'AR22', checked_by: 'test1', status: 'test', freezed_by: 'test', verification_officers: 4, item_code: 'AC23', batch_no: 21, },
                { stock_take_no: "12", stock_take_date: "12/06/2023", warehouse_code: 'AR22', checked_by: 'test1', status: 'test', freezed_by: 'test', verification_officers: 4, item_code: 'AC23', batch_no: 21, },
                { stock_take_no: "12", stock_take_date: "12/06/2023", warehouse_code: 'AR22', checked_by: 'test1', status: 'test', freezed_by: 'test', verification_officers: 4, item_code: 'AC23', batch_no: 21, },
                { stock_take_no: "12", stock_take_date: "12/06/2023", warehouse_code: 'AR22', checked_by: 'test1', status: 'test', freezed_by: 'test', verification_officers: 4, item_code: 'AC23', batch_no: 21, },
                { stock_take_no: "12", stock_take_date: "12/06/2023", warehouse_code: 'AR22', checked_by: 'test1', status: 'test', freezed_by: 'test', verification_officers: 4, item_code: 'AC23', batch_no: 21, },
    ...
    render() {
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title={"View & Approve Stock Takes"} />
...
export default InstitutionViewManage
