...
class PharmacistViewManage extends Component {
    constructor(props) {
        super(props)
        this.state = {
            buttonName: 'Filter',
                                    ...
                                    <Tooltip title="View">
                                        <IconButton
                                            ...
                                            onClick={() => {
                                                ...
                                                window.location.href = `/PharmacistViewManageDisplay` + "?owner_id=" + this.state.owner_id
    ...
    render() {
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title={"View & Check Stock Takes"} />
...
export default PharmacistViewManage
