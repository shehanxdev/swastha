...
class RegisterdPatients extends Component {
    constructor(props) {
        super(props)
        this.state = {
            drawerOpen: true,
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <Tooltip title="OPD">
                                            <IconButton
                                                ...
                                                onClick={() => {
                                                    let selected_data = this.state.data[tableMeta.rowIndex]
                                                    this.setState({ selectedPatient: selected_data, OPDdialogView: true })
                                                }}
                                                size="small"
                                                aria-label="view"
                                            >

                                                <LocalHospitalIcon style={{ color: '#F80E1A' }} />
                                            </IconButton>
                                        </Tooltip>
        ...
        return (
            <Fragment>
                ...
                <Dialog maxWidth="lg " open={this.state.OPDdialogView} /* onClose={() => { this.setState({ clinicdialogView: false }) }} */>
                    ...
                    <div className="w-full h-full px-5 py-5">
                        <AdmissionOPD patientDetails={this.state.selectedPatient}></AdmissionOPD>
                    </div>
                </Dialog>
...
export default withStyles(styleSheet)(RegisterdPatients)
