...
class AdmissionClinic extends Component {
    constructor(props) {
        super(props)
        this.state = {
            submitting: false,
        ...
        if (!this.state.isSubmitting) {
            ...
            if (null == this.state.patientObj) {
                ...
                if (201 == res.status) {
                    ...
                    url = url + "&clinicNo=" + String(clinic_data.store_id);
                    url = url + "&clinicName=" + String(clinic_data.name);
                    ...
                    this.setState({
                        alert: true,
                        message: res?.response?.data?.error ? res.response.data.error : 'Clinic patient Registration Unsuccessful',
                        severity: 'error',
                        submitting: false,
                    })
                }
...
export default withStyles(styleSheet)(AdmissionClinic)
