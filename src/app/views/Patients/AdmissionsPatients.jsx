    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                ...
                {
                    name: 'Admission Date Time',
                    label: 'Admission Date Time',
                    options: {
                        display: true,
                        customBodyRenderLite: (dataIndex) => {
                            let date = this.state.data[dataIndex].admit_date_time;
        ...
        return (
            <Fragment>
                ...
                <Dialog maxWidth="lg" open={this.state.registrationdialogView} >
                    ...
                    <div className="w-full h-full px-5 py-5">
                        <EditAdmission usage="update"  data={this.state.selectedPatient}></EditAdmission>
                    </div>
                </Dialog>


                <Dialog maxWidth="md" open={this.state.printDialogView} /* onClose={() => { this.setState({ admissiondialogView: false }) }} */>
                    ...
                    <div className="w-full h-full px-5 ">
                        <PrintDocuments patientDetails={this.state.selectedPatient} tab="admissions"></PrintDocuments>
                    </div>
                </Dialog>
