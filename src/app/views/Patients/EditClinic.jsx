...
class EditAdmission extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            all_hospitals: [],
            patientObj: {
                address:null, //this.props.data.address,
                age: null,
                citizenship:null, //this.props.data.citizenship,
                contact_no: null,
                contact_no2: null,
                createdAt: null,
                created_by: null,
    ...
    onSubmit = async () => {
        ...
        if (null == this.state.patientObj) {
            ...
            const patientClinicObj = {
                ...
                bht: bht ? "" + (bht.padStart(5, '0')) + "/" + moment().format('YYYY') : null,
                stat,
                                            ...
                                            >
                                                ...
                                                <RadioGroup row>
                                                    <FormControlLabel
                                                        ...
                                                        onChange={() => {
                                                            ...
                                                            if (formData != null || formData == "By Foot") {
                                                                formData.transportMode = 'By Foot';
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.transportMode == 'By Foot' ? true : false
                                                        }
                                                    />
                                                    ...
                                                    <FormControlLabel
                                                        ...
                                                        onChange={() => {
                                                            let formData = this.state.formData
                                                            formData.transportMode = 'Wheel Chair';
                                                            this.setState({
                                                                formData,
                                                            })
                                                        }}
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.transportMode == 'Wheel Chair' ? true : false
                                                        }
                                                    />
                                                    <FormControlLabel
                                                        label={'Trolley'}
                                                        ...
                                                        onChange={() => {
                                                            let formData = this.state.formData
                                                            formData.transportMode = 'Trolley';
                                                            this.setState({
                                                                formData,
                                                            })
                                                        }}
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.transportMode == 'Trolley' ? true : false
                                                        }
                                                    />
                                                </RadioGroup>
                                            ...
                                            >
                                                ...
                                                <RadioGroup row >
                                                    <FormControlLabel
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.stat == 'Normal' ? true : false
                                                    }  
                                                    />
