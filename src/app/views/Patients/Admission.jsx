        ...
        if (!this.state.isSubmitting) {
            ...
            if (null == this.state.patientObj) {
                ...
                if (201 == res.status) {
                    ...
                    url = url + "&wardName=" + String(this.state.clinicData.find((v) => v.id == this.state.formData.clinicId).name);
                                            ...
                                            >
                                                ...
                                                <RadioGroup row>
                                                    <FormControlLabel
                                                        ...
                                                        onChange={() => {
                                                            ...
                                                            if (formData != null || formData == "By Foot") {
                                                                formData.transport_mod = 'By Foot';
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.transport_mod == 'By Foot' ? true : false
                                                        }
                                                    />
                                                    ...
                                                    <FormControlLabel
                                                        ...
                                                        onChange={() => {
                                                            let formData = this.state.formData
                                                            formData.transport_mod = 'Wheel Chair';
                                                            this.setState({
                                                                formData,
                                                            })
                                                        }}
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.transport_mod == 'Wheel Chair' ? true : false
                                                        }
                                                    />
                                                    <FormControlLabel
                                                        label={'Trolley'}
                                                        ...
                                                        onChange={() => {
                                                            let formData = this.state.formData
                                                            formData.transport_mod = 'Trolley';
                                                            this.setState({
                                                                formData,
                                                            })
                                                        }}
                                                        ...
                                                        display="inline"
                                                        checked={this.state.formData.transport_mod == 'Trolley' ? true : false
                                                        }
                                                    />
                                                </RadioGroup>
