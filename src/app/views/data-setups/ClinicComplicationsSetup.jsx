...
class ClinicComplicationsSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    handleDataSubmit = async () => {
        ...
        if (!this.state.isUpdate) {
            //save function
            res = await ClinicDataSetupService.createNewClinicComplication(
                clinicComplicationDto
            )
        } else {
            res = await ClinicDataSetupService.updateClinicComplication(
                this.state.catId,
                clinicComplicationDto
            )
        }
    ...
    async fetchDataSet() {
        ...
        const res = await ClinicDataSetupService.fetchAllComplication(
            filterData
        )
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Complication Setup" />
...
export default withStyles(styleSheet)(ClinicComplicationsSetup)
