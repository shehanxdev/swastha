...
class ClinicAllergiesSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
        ...
        return (
            <Fragment>
                <MainContainer>
                    {/* Filtr Section */}
                    <LoonsCard>
                        <CardTitle title="Allergies Setup" />
                                ...
                                <Grid item xs={12} sm={12} md={12} lg={12}>
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid
                                            ...
                                            lg={12}
                                        >
                                            <SubTitle title="Add, Edit, Delete Allergies" />
...
export default withStyles(styleSheet)(ClinicAllergiesSetup)
