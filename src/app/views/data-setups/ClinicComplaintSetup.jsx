...
class ClinicComplaintSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    handleDataSubmit = async () => {
        ...
        if (!this.state.isUpdate) {
            //save function
            res = await ClinicDataSetupService.createNewClinicCompliants(
                clinicComplaints
            )
        } else {
            res = await ClinicDataSetupService.updateClinicComplaints(
                this.state.catId,
                clinicComplaints
            )
        }
    ...
    async fetchDataSet() {
        ...
        const res = await ClinicDataSetupService.fetchAllCompliants(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Complaints Setup" />
...
export default withStyles(styleSheet)(ClinicComplaintSetup)
