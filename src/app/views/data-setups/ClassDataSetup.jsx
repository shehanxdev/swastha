...
class ClassDataSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    clearField = () => {
        ...
        handleDataSubmit = async () => {
            ...
            if (this.state.isUpdate) {
                res = await ClassDataSetupService.updateClass(this.state.id, formData)
                ...
                if (200 == res.status) {
                    ...
                    this.setState({
                        alert: true,
                        message: 'Class Data Updated Unsuccessful',
                        severity: 'error',
                    })
                }
                ...
                //save function
                res = await ClassDataSetupService.createNewClass(formData)
                ...
                if (201 == res.status) {
                    this.setState({
                        alert: true,
                        message: 'Class Data Successfully Stored',
                        severity: 'success',
                    })
                    this.fetchDataSet()
                } else {
                    this.setState({
                        alert: true,
                        message: 'Class Data Registration Unsuccessful',
                        severity: 'error',
                    })
                }
            }
    ...
    async fetchDataSet() {
        ...
        const res = await ClassDataSetupService.fetchAllClass(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Class Management" />
...
export default withStyles(styleSheet)(ClassDataSetup)
