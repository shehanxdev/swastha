                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                'Normal Order Item / Special Order Item'
                            )
                        }
                    },
                },
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                parseInt(this.state.data[tableMeta.rowIndex].request_quantity) : 'N/A'
                            )
                        }
                    },
                },
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                this.state.data[tableMeta.rowIndex].approved_quantity ?
                                parseInt(this.state.data[tableMeta.rowIndex].approved_quantity) : 'N/A'
                            )
                        }
                    },
                },
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                this.state.data[tableMeta.rowIndex].issued_quantity ?
                                parseInt(this.state.data[tableMeta.rowIndex].issued_quantity) : 'N/A'
                            )
                        }
                    },
                },
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                this.state.data[tableMeta.rowIndex].recieved_quantity ?
                                    parseInt(this.state.data[tableMeta.rowIndex].recieved_quantity) : 'N/A'
                            )
                        }
                    },
                },
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                this.state.data[tableMeta.rowIndex].OrderExchange.recieved_date : 'N/A'
                            )
                        }
                    },
                },
            ...
            <Fragment>
                    ...
                    <Grid container>
                        ...
                        <Grid item lg={3} md={3} sm={3} xs={3} className="px-2">
                            ...
                            <Autocomplete
                                        disableClearable
                                className="w-full"
                                options={[{ label: "Normal Order Item ", value: "Normal Order Item" }, { label: "Special Order Item", value: "Special Order Item" }]}
                                /*  defaultValue={dummy.find(
                                     (v) => v.value == ''
                                 )} */
                                ...
                                //         filterData.order_item_type = value.value

                                //         // this.setState({ filterDataValidation })

                                //     } else {
                                //         filterData.order_item_type = null
                                //     }
                                //     this.setState({ filterData })
                                // }}
                ...
                <Grid container className="mt-2 pb-5">
                    <Grid item lg={12} md={12} sm={12} xs={12}>
                        ...
                        <Grid item lg={12} md={12} sm={12} xs={12} style={{ display: 'flex', justifyContent: 'flex-end' }}>
                            {
                                this.state.Loaded ?
                                    (
                                        <Button
