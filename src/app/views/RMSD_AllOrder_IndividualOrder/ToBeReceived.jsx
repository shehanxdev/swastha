    ...
    async loadOrderList(filters) {
        ...
        if (res.status) {
            ...
            this.setState({
                ...
                Loaded: true,
                to_be_received: res.data.view.totalItems ? res.data.view.totalItems:0,
                ...
                <ValidatorForm
                    ...
                    <Grid container>
                        <Grid lg={12} md={12} sm={12} xs={12} style={{ textAlign: 'end' }} className='pr-5'>
                            <h3>No of to be Received : {this.state.to_be_received}</h3>
                        </Grid>
...
export default withStyles(styleSheet)(ToBeReceived)