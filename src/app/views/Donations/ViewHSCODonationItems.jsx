                        ...
                        customBodyRenderLite: (dataIndex) => {
                            ...
                            return (
                                <Grid className="flex items-center">
                                    ...
                                    {/* <IconButton
                                        onClick={() => {
                                            window.location.href = `/donation/view-hsco-donation-registration-note/${id}/${donation_id}`
                                        }}
                                        className="px-2"
                                        size="small"
  ...
  async loadDonors(search) {
    ...
    render(){
        ...
        return(
            <MainContainer>
                <LoonsCard>
                    <CardTitle title="View Donations Items HSCO" />
                            ...
                            >
                                ...
                                />
                                    ...
                                    >
                                        ...
                                        size="small"
                                    className="w-full"
                                    placeholder="Type Item Name No"
                                                    onChange={(e) => {
                                                            let filterData = this.state.filterData;
                                                            filterData.name = e.target.value;
                                                            console.log('Item No',filterData)
                                                            this.setState(
                                                                {
                                                                    filterData,
                                                                }
                                    ...
                                    >
                                        ...
                                        disableClearable
                                            ...
                                            onChange={(e) => {
                                                // if (null != value) {
                                                    let filterData = this.state.filterData;
                                                    filterData.donor_country = e.target.value;
                                                    this.setState({ filterData })
                                                // }
                                            }} 
