...
class DonerEntryList extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data : null,
                            ...
                            <div>
                                ...
                                <div ref={(el) => (this.componentRef = el)} >
                                    <Grid className="w-full">   
                                        ...
                                        <Grid container>
                                            <Grid item sm={12}>
                                                <p style={{textAlign:"center", fontWeight:"bold"}}>Donation Entry List</p>
                                            </Grid>
                                                      ...
                                                      <table style={{width:"250%" , borderCollapse:"collapse"}}>
                                                        {item?.DonationItemsBatches.map((item2,i)=>(
                                                             <tr style={{width:"100%", borderCollapse:"collapse"}}>
                                                                 <td style={{width:"40%", border:"0.5px solid black", textAlign:"center"}} >{item2?.batch_no}</td>
                                                                 <td style={{width:"25%", border:"0.5px solid black", textAlign:"center"}} >{dateParse(item2?.expiary_date)}</td>
                                                                 <td style={{width:"35%", border:"0.5px solid black", textAlign:"center"}} >{item2?.received_quantity}</td>
                                                            </tr>
                                                        )
                                                        )}
                                                        </table>
