...
import {DatePicker, Button, LoonsTable } from "app/components/LoonsLabComponents";
...
class MSD_SCO_View extends Component {
    constructor(props) {
        super(props)
        this.state = {
             //snackbar
            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return this.state.data[tableMeta.rowIndex]?.Donor?.name
                        }
                    }
                },
                {
                    ...
                    options: {
                        ...
                        width: 10,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return this.state.data[tableMeta.rowIndex]?.Donor?.country
                        }
                    },
                },
                {
                ...
                //                     {value
                //                         ? dateParse(
                //                               moment(this.state.data[tableMeta.rowIndex]?.Donor?.delivery_date).format('YYYY-MM-DD')
                //                           )
                //                         : ''}
                //                 </span>
                //             )
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            ...
                            return (
                                <Grid className="flex items-center">
                                    ...
                                    <IconButton
                                        onClick={() => {
                                            window.location.href = `/donation/sco-view-donation-items/${id}/${donar_id}`
                                        }}
                                        className="px-2"
                                        size="small"
