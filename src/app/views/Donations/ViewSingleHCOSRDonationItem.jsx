       ...
       <Grid item lg={3} md={3} sm={12} xs={12}>
                     ...
                     <Grid
                            ...
                            <Button
                                ...
                                progress={false}
                                type="submit"
                                disabled={this.state.formData.status == "Submitted to AD" ||this.state.formData.status == "Rejected by HSCO"  ?true : false }
                                scrollToTop={true}
                                onClick={  
                                    ()=>{
