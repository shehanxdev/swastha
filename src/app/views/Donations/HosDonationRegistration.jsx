...
class HosDonationRegistration extends Component {
    constructor(props) {
        super(props)
        this.state = {
             //snackbar
    ...
    async loadAllEmployees() {
        ...
        let res = await EmployeeServices.getEmployees({type: "MSD MSA"})
...
export default withStyles(styleSheet)(HosDonationRegistration)