import {
    Button, CircularProgress, Dialog, Divider, Grid, InputAdornment, Typography, FormControlLabel, Radio, Tabs,
    ...
    async componentDidMount() {
        ...
        if (
            ...
            this.setState({
                ...
                selected_Warehouse: selected_Warehouse.id,
                ...
                <div>
                    {this.state.activeTab == 0 ?
                        <div className='w-full'>
                            <Expired warehouse_id={this.state.selected_warehouse} status={"Expired Drugs"}></Expired>
                        </div>
                        : null
                    }
                    {this.state.activeTab == 1 ?
                        <div className='w-full'>
                            <Expired warehouse_id={this.state.selected_warehouse} status={"Batch Withhold"}></Expired>
                        </div> : null
                    }
                    {this.state.activeTab == 2 ?
                        <div className='w-full'>
                            <Expired warehouse_id={this.state.selected_warehouse} status={"Batch Withdraw"}></Expired>
                        </div> : null
                    }
                    {this.state.activeTab == 3 ?
                        <div className='w-full'>
                            <Expired warehouse_id={this.state.selected_warehouse} status={"Item Withhold"}></Expired>
                        </div> : null
                    }

                    {this.state.activeTab == 4 ?
                        <div className='w-full'>
                            <Expired warehouse_id={this.state.selected_warehouse} status={"Item Withdraw"}></Expired>
                        </div> : null
                    }
                    {this.state.activeTab == 5 ?
                        <div className='w-full'>
                            <Expired warehouse_id={this.state.selected_warehouse} status={"Under Serveilance"}></Expired>
                        </div> : null
                    }
