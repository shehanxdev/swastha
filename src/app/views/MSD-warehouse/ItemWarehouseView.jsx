...
class ItemWarehouseView extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loaded: true,
            ...
            <Fragment>
                ...
                <MainContainer>
                   {this.state.loaded?<div>
                        ...
                        <CardTitle title="Single Item in All Warehouses" />
                  ...
                  </div> : <Grid className="justify-center text-center w-full pt-12">
...
export default ItemWarehouseView
