...
class WarehouseItemTransfer extends Component {
                  ...
                  {items.map((value) => {
                      ...
                      return (
                          ...
                          >
                              ...
                              <ListItemText
                                  id={labelId}
                                  primary={`${value?.ItemSnap?.medium_description}`}
                              />
                          </ListItem>
                      )
                  })}
...
export default withStyles(styleSheet)(WarehouseItemTransfer)