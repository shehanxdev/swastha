...
class TabHandling extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            filterData2: {
                ...
                // sr:null,
                // itemName:null,
                ven: this.props.filterData.ven,
              //   category_code: null,
                category_name: this.props.filterData.category_name,
              //   group_code: null,
                group: this.props.filterData.group,
              //   class_short_ref: null,
                class_name: this.props.filterData.class_name,
                serial_code: this.props.filterData.serial_code,
                order_by_sr :true
    ...
    async removeEntry() {
            ...
            console.log("orderToDelete", this.state.orderToDelete);
            ...
            if (res.status) {
                ...
                const errorMessage = res?.response?.data?.error; // show back end error
                // console.log('resresres', res?.response?.data?.error)
                this.setState({
                  Loaded: true,
                  alert: true,
                  ...
                  {items.map((value) => {
                      ...
                      return (
                          ...
                          >
                              ...
                              <ListItemText
                                  id={labelId}
                                  primary={`${value.sr_no} - ${value.medium_description}`}
                              />
                          </ListItem>
                      )
                  })}
