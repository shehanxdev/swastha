...
import WarehouseItemTransfer from './WarehouseItemTransfer'
...
class ItemTrasfer extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isUpdate: true,
...
{/* 
                                ...
                                <Grid className='mt-4'>
                                {this.state.loaded? 
                                <WarehouseItemTransfer id ={this.props.id} filterData={this.state.filterData}/> 
                                : null
                            } 
                                </Grid>
...
export default withStyles(styleSheet)(ItemTrasfer)
