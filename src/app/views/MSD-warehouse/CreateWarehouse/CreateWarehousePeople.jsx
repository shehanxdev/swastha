...
class CreateWarehousePeople extends Component {
    ...
    async GetUserInfo() {
        ...
        this.setState({
            loginedUserRoles: userInfo.roles
        }, () => { this.getUserTypes() })
    }

    async getUserTypes() {
        if (this.state.loginedUserRoles.includes("RMSD ADMIN")) {
            this.setState({ empType: [{ type: 'RMSD OIC' }, { type: 'RMSD MSA' }, { type: 'RMSD Pharmacist' }] })
        } else if (this.state.loginedUserRoles.includes("MSD ADMIN")||this.state.loginedUserRoles.includes("MSD AD")) {
            this.setState({ empType: [{ type: 'MSD MSA' }] })
        }
    }
    ...
    async loadData() {
       ...
       // filterData.type = 'MSD MSA'
        filterData.pharmacy_drugs_stores_id=this.props.id
