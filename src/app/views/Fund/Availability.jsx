        ...
        return (
            <Fragment>
                <MainContainer>
                    {/* Filtr Section */}
                    <LoonsCard>
                        <CardTitle title="Fund Availability" />
                        <ValidatorForm
                            className="pt-2"
                                ...
                                <Grid item xs={12} sm={12} md={12} lg={12}>
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        >
                                            <Grid container spacing={2}>
                                                ...
                                                <Grid
                                                    ...
                                                    xs={12}
                                                >
                                                    <SubTitle title="Scheduled Year" />
                                                    <DatePicker
                                                        className="w-full" onChange={(date) => {
                                                            let formData = this.state.formData
                                                            formData.year = dateParse(date)
                                        ...
                                        disableClearable className="w-full"
                                                        ...
                                                        value={this.state.code_items.find((v) => v.id == this.state.formData.id)}
...
export default withStyles(styleSheet)(Availability)
