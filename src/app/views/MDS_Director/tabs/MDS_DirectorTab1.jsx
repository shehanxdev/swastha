...
import MDS_DirectorAllOrderss from './tabs/MDS_DirectorAllOderss';
import MDS_DirectorApproved from './tabs/MDS_DirectorAproved';
import MDS_DirectorRejected from './tabs/MDS_DirectorRejected';
...
export default function CPTab1() {
    ...
    <Grid container="container" spacing={2}>
        ...
        <TabPanel value={value} index={0} dir={theme.direction}>
            <MDS_DirectorAllOrderss/>
        </TabPanel>
        <TabPanel value={value} index={1} dir={theme.direction}>
            <MDS_DirectorApproved/>
        </TabPanel>
        <TabPanel value={value} index={2} dir={theme.direction}>
            <MDS_DirectorRejected/>
        </TabPanel>
    </Grid>
</>
    );
