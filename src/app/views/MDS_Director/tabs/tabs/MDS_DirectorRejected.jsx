...
class MDS_DirectorRejected extends Component {
        ...
        return (
            <MainContainer>
                ...
                <Grid
                    ...
                    <Typography variant="h5" className="font-semibold">Rejected Oders</Typography>
                    {/* <div>
                        <LoonsButton
                            color='primary'
                            onClick={() => {
...
export default MDS_DirectorRejected