...
class MDS_DirectorApproved extends Component {
            ...
            data: [
                {
                    pharmacy: '27653',
                    request_date: '263465',
                    counter_pharmacist_id: '743',
                    pharmacist_name: 'jdgah',
                    order_id: '134',
                    total_items: '15',
                    required_date: '13654',
                    status: 'jhga'
    ...
    async loadData() {
        ...
        if (orders.status == 200) {
            ...
            this.setState(
                {data: orders.data.view.data, loaded: true, totalItems: orders.data.view.totalItems}
            )
        }
    ...
    async loadWarehouses() {
        ...
        if (!selected_warehouse_cache) {
            ...
            this.state.filterData.owner_id = selected_warehouse_cache.owner_id
            ...
            <MainContainer>
                {/* <Grid container="container" spacing={2}>
                    <Grid item="item" xs={12}>
                        <Typography variant="h4" className="font-semibold">All Orders</Typography>
                        <Divider/>
                    </Grid>
                </Grid>
                <div
                    ...
                    }}>
                    {
                        this
                            ...
                            .cards
                            .map((value, index) => (
                                <div style={{width:'390px'}} className="mb-6 mt-6 ml-2 mr-2">
                                    <PharmacyCards />
                                </div>
                            ))
                    }
                ...
                <Grid
                    ...
                    <Typography variant="h5" className="font-semibold">Approved Oders</Typography>
                    {/* <div>
                        <LoonsButton
                            color='primary'
                            onClick={() => {
                ...
                <Grid container="container" spacing={2}>
                    <Grid item="item" xs={12}>
                        <Typography variant="h5" className="font-semibold mt-6">Filters</Typography >
                        <Divider></Divider>
                    </Grid>
                </Grid>
                    ...
                    <Grid container="container" spacing={2}>
                        <Grid item="item" lg={4} md={4} sm={12} xs={12}>
                            ...
                            <Autocomplete
                                ...
                                (v) => v.id == this.state.filterData.district_id
                                )} */
                                value={this
                                    .state
                                    .all_pharmacy
...
/>
                        ...
                        <Grid item="item" lg={4} md={4} sm={12} xs={12}>
                            <SubTitle title="From"/>
                            <LoonsDatePicker className="w-full" value={this.state.filterData.from_date} placeholder="From"
                                // minDate={new Date()}
...
export default MDS_DirectorApproved