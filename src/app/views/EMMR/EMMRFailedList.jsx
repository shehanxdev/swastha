...
class EMMRFailedList extends Component {
    constructor(props) {
        super(props)
        this.state = {
            drawerOpen: true,
            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        display: true,
                        customBodyRenderLite: (dataIndex) => {
                            if (this.state.data[dataIndex].send_error.length !== 0) {
                                return JSON.stringify(this.state.data[dataIndex].send_error)
                            }
                        },
                    },
                },
    ...
    async searchPatients() {
        ...
        this.setState({ Loaded: false })
                ...
                formData.hospital_id = [hospitals[0].Pharmacy_drugs_store.id]

        
        // let formData = this.state.formData;
        // // formData.type = 'Ward';
        // let store_data = await localStorageService.getItem('add');
        // if (store_data == null) {
        ...
        const patientdata = await PatientServices.getSuccessList(newParams)

        console.log('formData',newParams)
...
export default withStyles(styleSheet)(EMMRFailedList)