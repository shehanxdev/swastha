...
class SuppliesDivisionAccountant extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loaded: false,
            ...
            columns: [
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            ...
                            return (
                                <Grid className="flex items-center">
                                    ...
                                    <Grid className="px-2">
                                        <Tooltip title="Stock Costing">
                                            <IconButton
                                                onClick={() => {
                                                    window.location.href = `/consignments/stock-costing/${id}`
                                                }}
                                            >
                ...
                {
                    name: 'invoice_date', // field name in the row object
                ...
                {
                    name: 'values_in_lkr', // field name in the row object
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <span>
                                    {value ? convertTocommaSeparated(value,2) : ''}
                                </span>
                            )
                        },
                    },
...
export default SuppliesDivisionAccountant
