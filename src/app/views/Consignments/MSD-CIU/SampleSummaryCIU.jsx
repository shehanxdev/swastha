    ...
    constructor(props) {
        ...
        this.state = {
            ...
            filterData: {
                ...
                status:["AD Recommended", "Director Recommended"]
            },
                    ...
                    options: {
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            ...
                            return <Grid className="flex items-center">
                                ...
                                <Grid className="px-2">
                                    {(status == "AD Recommended" || status == "Director Recommended") ?
                                        <Tooltip title="View Sample">
                                            <IconButton
                                                onClick={() => {
                                                    window.location.href=`/consignments/msdCIU/approveSample/${this.state.data[dataIndex].id}?type=CIU_View`;
                                                }}>
