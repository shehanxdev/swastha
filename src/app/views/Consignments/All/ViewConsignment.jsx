...
import { LoonsCard, Button, SubTitle } from "app/components/LoonsLabComponents";
...
class ViewConsignment extends Component {
               ...
               /*  {
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <p> {convertTocommaSeparated(this.state.data.ConsignmentItems[tableMeta.rowIndex].item_schedule.Order_item.quantity,2)} </p>
                            )
                        },
                    },
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <p> {convertTocommaSeparated(this.state.data.ConsignmentItems[tableMeta.rowIndex].item_schedule.quantity,2)} </p>
                            )
                        },
                    },
                },
                {
                    ...
                    options: {
                        filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            let data = Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].quantity)
                            return (
                                <p> {convertTocommaSeparated(data,2)} </p>
                            )
                        },
                ...
                },
                {
                    ...
                    options: {
                        filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            let data = Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].invoice_price)
                            return (
                                <p> {convertTocommaSeparated(data,2)} </p>
                            )
                        },
                ...
                },
                {
                    ...
                    options: {
                        filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            let data = Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].item_schedule.Order_item.quantity) * Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].purchase_price)
                            return (
                                <p> {convertTocommaSeparated(data,2)} </p>
                            )
                        },
                ...
                },
                {
                    ...
                    options: {
                        filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            let data = Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].item_schedule.quantity) * Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].invoice_price)
                            return (
                                <p> {convertTocommaSeparated(data,2)} </p>
                            )
                        },
                ...
                },
                {
                    ...
                    options: {
                        filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            let data = Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].quantity) * Number(this.state.data.ConsignmentItems[tableMeta.rowIndex].invoice_price)
                            return (
                                <p> {convertTocommaSeparated(data,2)} </p>
                            )
                        },
    ...
    async getDebitNoteById() {
        ...
        console.log("debit note", this.state.data);
    }
