    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            ...
                            return <Grid>
                                ...
                                <Grid className="flex items-center">
                                    ...
                                    <Grid className="px-2">
                                        {(status == "SCO Checked" || status == "Director Returned") ?
                                            <Tooltip title="Approve Sample">
                                                <IconButton
                                                    onClick={() => {
                                                        window.location.href = `/consignments/msdAd/approveSample/${this.state.data[dataIndex].id}`;
                                                    }}>
                ...
                {
                    name: 'Order No', // field name in the row object
                    label: 'Order No', // column title that will be shown in table
                    options: {
                        filter: false,
                        display: true,
                        customBodyRenderLite: (dataIndex) => {
                            let data = this.state.data[dataIndex].item?.Consignment?.order_no
                            return <p>{data}</p>
                        },
                    },
                },
