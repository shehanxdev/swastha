            ...
            columns: [
                    ...
                    options: {
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            ...
                            return <Grid>
                                ...
                                <Grid container className="px-2 row">
                                    {(status == "SCO Sample Collected" || status == "AD Returned") ?
                                        <Grid item>
                                            <Tooltip title="Approve Sample">
                                                <IconButton
                                                    onClick={() => {
                                                        window.location.href = `/msd/sco/accept-sample-info/${this.state.data[dataIndex].id}`;
                                                    }}>
                                    ...
                                    {(status == "Active") ?
                                        <Grid item>
                                            <Tooltip title="Confirm Sample">
                                                <IconButton
                                                    onClick={() => {
                                                        window.location.href = `/consignments/confirm-samples/${this.state.data[dataIndex].id}`
                                                    }}>
                                    ...
                                    {(status == "SCO Sample Collected" || status == "AD Returned" || status == "Active") ?
                                        null :
                                        <Grid item>
                                            <Tooltip title="View">
                                                <IconButton
                ...
                },
                {
                    ...
                    options: {
                        ...
                        display: true,
                        customBodyRenderLite: (dataIndex) => {
                            let data = this.state.data[dataIndex].item?.Consignment?.invoice_no
                            return <p>{data}</p>
                        },
                    },
                },
                ...
                },
                {
                    ...
                    options: {
                        ...
                        display: false,
                        customBodyRenderLite: (dataIndex) => {
                            let data = this.state.data[dataIndex].sco?.createdAt
