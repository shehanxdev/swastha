...
import ComparisonChart from '../Estimations/ComparisonChart'
import {
    Grid,
    Typography,
    Tabs,
                ...
                //   },
                  ...
                  },
                  {
                    ...
                    options: {
                        ...
                        display: false,
                        customBodyRenderLite: (dataIndex) => {
                            let data = this.state.data[dataIndex].ItemSnap.VEN.name;
                            return <p>{data}</p>
 ...
 */}
                        ...
                        <Grid item lg={12} md={12} xs={12}>
                            <Tabs
                                ...
                                <Tab label={<span className="font-bold text-12">Warehouse Inventory</span> } />
                                <Tab label={<span className="font-bold text-12">Behavior for Past 3 Years</span>} />
                        ...
                        <main>
                                    ...
                                    ></LoonsTable>
                                          ...
                                          //changing items from one warehouse
                  //                   <Fragment>
                  //                       {
                  ...
                  //       {this.state.loaded ? (
                  //              <LoonsCard>
                  //           <Grid container={2} className="mt-5 pb-5">
...
export default withStyles(styleSheet)(WarehouseDetails)