...
class OrderBase_ToBeIssued extends Component {
                ...
                <MainContainer>
                    <Grid container="container" spacing={2}>
                        <Grid item="item" xs={12}>
                            <Typography variant="h5" className="font-semibold">PENDING DELIVERY</Typography>
                            <Divider/>
                        </Grid>
                    </Grid>
                    {/* {this.state.loaded ?
    ...
    export default OrderBase_ToBeIssued