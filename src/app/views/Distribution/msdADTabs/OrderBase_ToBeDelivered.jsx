...
import {dateTimeParse, dateParse,includesArrayElements} from "utils";
import ClinicService from "app/services/ClinicService";

class OrderBase_ToBeDelivered extends Component {
    ...
    constructor(props) {
        ...
        async loadData() {
            ...
            let formData = this.state.formData
            if (includesArrayElements(distribution_ID.roles, ['MSD AD','MSD MSA Dispatch'])) {
                formData.to_owner_id= '000'
            }else{
                ...
                <MainContainer>
                    <Grid container="container" spacing={2}>
                        <Grid item="item" xs={12}>
                            <Typography variant="h5" className="font-semibold">TO BE COMPLETED</Typography>
                            <Divider/>
                        </Grid>
                    </Grid>
                    {/* {this.state.loaded ?
    ...
    export default OrderBase_ToBeDelivered