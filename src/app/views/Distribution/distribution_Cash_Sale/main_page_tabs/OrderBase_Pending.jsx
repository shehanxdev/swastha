...
class OrderBase_Pending extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formData: {
                ...
                from_date: null,
                to_date: null,
                status: ['Pending','APRROVED','APPROVED'/* 'ALLOCATED' */],
                date_type: null,
                from: null,
                search:null,
                ...
                <MainContainer>
                    <Grid container="container" spacing={2}>
                        <Grid item="item" xs={12}>
                            <Typography variant="h5" className="font-semibold">PENDING</Typography>
                            <Divider/>
                        </Grid>
                    </Grid>
                    {/* {this.state.loaded ?
    ...
    export default OrderBase_Pending