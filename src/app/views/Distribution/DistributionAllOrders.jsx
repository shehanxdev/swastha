...
import OrderBase_Pending from './main_page_tabs/OrderBase_Pending'
import OrderBase_PendingIssue from './main_page_tabs/OrderBase_PendingIssue'
import OrderBase_Rejected from './main_page_tabs/OrderBase_Rejected'
...
class DistributionAllOrders extends Component {
    ...
    async handleSubmit() {
        ...
        console.log("coverup emp",await localStorageService.getItem('userInfo').id)
                                        ...
                                        <div className='w-full'>
                                            ...
                                            {this.state.Loaded ? (
                                                ...
                                                <Fragment>
                                                    ...
                                                    {this.state.activeSecondaryTab == 7 ?
                                                        <div className='w-full'>
                                                            <OrderBase_AllOrders />
                                                        </div> : null
                                                    }
                                                    {this.state.activeSecondaryTab == 8 ?
                                                        <div className='w-full'>
                                                            <OrderBase_Rejected />
