...
class CashSales extends Component {
    ...
    async handleSubmit() {
        ...
        formData.covered_up_employee_id = await this.state.selected_coverUp_emp.id;
                ...
                <MainContainer>
                    <LoonsCard>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                            <Typography variant="h6" className="font-semibold">Cash Sales</Typography>
                            <LoonsButton
                                color='primary'
                                onClick={() => {
                                            ...
                                            {this.state.Loaded ? (
                                                ...
                                                <Fragment>
                                                    ...
                                                    {this.state.activeSecondaryTab == 0 ?
                                                        <div className='w-full'>
                                                            <OrderBase_ToBeAllocated type={"CASH SALES"} />

                                                        </div> : null
                                                    }
                                                    {this.state.activeSecondaryTab == 1 ?
                                                        <div className='w-full'>
                                                            <OrderBase_ToBeIssued type={"CASH SALES"} />
                                                        </div> : null
                                                    }
                                                    {this.state.activeSecondaryTab == 2 ?
                                                        <div className='w-full'>
                                                            <OrderBase_ToBeApproved type={"CASH SALES"} />
                                                        </div> : null
                                                    }
                                                    {
                                                        this.state.activeSecondaryTab == 3 ?
                                                            <div className='w-full'>
                                                                <OrderBase_ToBeDelivered type={"CASH SALES"} />

                                                            </div> : null
                                                    }
                                                    {this.state.activeSecondaryTab == 4 ?
                                                        <div className='w-full'>
                                                            <OrderBase_Completed type={"CASH SALES"} />
                                                        </div> : null
                                                    }
                                                    {this.state.activeSecondaryTab == 5 ?
                                                        <div className='w-full'>
                                                            <OrderBase_AllOrders type={"CASH SALES"} />
                                                        </div> : null
                                                    }
...
export default withStyles(styleSheet)(CashSales)