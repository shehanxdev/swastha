...
class OrderBase_Rejected extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formData: {
                ...
                from_date: null,
                to_date: null,
                status: ['REJECTED','SYSTEM REJECTED'],
                date_type: null,
                from: null,
                search:null,
                ...
                <MainContainer>
                    <Grid container="container" spacing={2}>
                        <Grid item="item" xs={12}>
                            <Typography variant="h5" className="font-semibold">REJECTED</Typography>
                            <Divider/>
                        </Grid>
                    </Grid>
                    {/* {this.state.loaded ?
    ...
    export default OrderBase_Rejected