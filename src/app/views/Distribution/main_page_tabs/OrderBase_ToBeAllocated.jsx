...
class OrderBase_ToBeAllocated extends Component {
    ...
    constructor(props) {
        ...
        async loadData() {
            this.setState({loaded: false})
            let distribution_ID = await localStorageService.getItem("coverUpInfo") ? await localStorageService.getItem("coverUpInfo") : await localStorageService.getItem("userInfo");
