...
class SupplementaryOrders extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formData: {
                ...
                page: 0,
                to_owner_id:'000',
                special_normal_type:'SUPPLEMENTARY',
                //owner_id: null,
        ...
        async loadData() {
           ...
           // formData.distribution_officer_id = distribution_ID.id
            ...
            if (orders.status == 200) {
                console.log('Orders details', orders.data.view.data)
    ...
    async getPharmacyDet(formOwnID, mainData) {
        ...
        console.log('data cheking for test', this.state.data)
    ...
    export default SupplementaryOrders