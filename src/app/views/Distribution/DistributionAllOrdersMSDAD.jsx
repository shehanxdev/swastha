...
import OrderBase_AllOrders from './msdADTabs/OrderBase_AllOrders'
import OrderBase_ToBeApproved from './msdADTabs/OrderBase_ToBeApproved'
import OrderBase_ToBeIssued from './msdADTabs/OrderBase_ToBeIssued'
import OrderBase_ToBeAllocated from './msdADTabs/OrderBase_ToBeAllocated'
import OrderBase_ToBeDelivered from './msdADTabs/OrderBase_ToBeDelivered'
import OrderBase_Dispatched from './msdADTabs/OrderBase_Dispatched'
import OrderBase_Completed from './msdADTabs/OrderBase_Completed'
...
class DistributionAllOrdersMSDAD extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeTab: 0,
                                            ...
                                            {this.state.Loaded ? (
                                                ...
                                                <Fragment>
                                                    ...
                                                    {this.state.activeSecondaryTab == 5 ?
                                                     ...
                                                     {this.state.activeSecondaryTab == 6 ?
                                                        <div className='w-full'>
                                                             <OrderBase_AllOrders />
                                                        </div> : null
                                                    } 
...
export default withStyles(styleSheet)(DistributionAllOrdersMSDAD)