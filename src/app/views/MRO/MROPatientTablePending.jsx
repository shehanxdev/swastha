...
class MROPatientTablePending extends Component {
    constructor(props) {
        super(props)
        this.state = {
            drawerOpen: true,
    ...
    async searchPatients() {
        ...
        let newParams={
            ...formData,...{
                ...
                mro_status: 'Pending',
                status:['Discharged','Pending','Transfer','Active','Admitted','Shared Care'],
                type: 'Ward'
            }
...
export default withStyles(styleSheet)(MROPatientTablePending)