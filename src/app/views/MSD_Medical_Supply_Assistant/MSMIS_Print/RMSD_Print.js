...
class RMSD_Print extends Component {
    constructor(props) {
        super(props)
        this.state = {
            consultant: null,
    ...
    async loadData() {
        ...
        if (res.status) {
            ...
            this.setState({ data: res.data.view.data, userName: userName }, () => { this.getPacksizeDetails(this.state.data) })
        }
    ...
    async loadInstitute(owner_id) {
        ...
        console.log('check department', this.state.hospital)
    }
                                                            ...
                                                            {(newPage || (index == 0 && batchIndex == 0)) &&
                                                                <div className="w-full">
                                                                    ...
                                                                    <div className="w-full font-bold text-20 text-center">
                                                                        Regional Medical Supplies Division - Ministry of Health
                                                                    </div>
                                                                                    ...
                                                                                    <p className="text-12 l my-0 ml-2 ">
                                                                                        {
                                                                                            this.state
                                                                                                ...
                                                                                                ?.name + ' (' + this.state.hospital?.Department?.name + ')'
                                                                                        }
                                                                                    </p>
                                                                                </div>
                                                                                <div className="flex">
 ...
 */}
                                                            ...
                                                            {(reminder_batch_count == 0) &&
                                                                <div className='w-full'>
                                                                    ...
                                                                    {this.footer(pageRemineHeight - 10, pageItemCount)}
                                                                </div>
                                                            }
