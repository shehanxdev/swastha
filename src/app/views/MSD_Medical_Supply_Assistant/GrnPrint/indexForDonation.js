...
class GRNDonationPrint extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: null,
        ...
        return (
            <div className="hidden">
                <Grid className="w-full justify-end items-end flex">
                    <ReactToPrint
                        trigger={() => <Button id="print_presc_02" size="small" startIcon="print">Print</Button>}
                        pageStyle={pageStyle}
                                            ...
                                            <Grid className="w-full" container>
                                                ...
                                                <Grid item xs={12} className="mt-5">
                                                    <table style={{ width: '100%' }}>
                                                        ...
                                                        <tr>
                                                            <td style={{ width: '20%', fontWeight: 'bold', fontSize: '12px' }}>Donation No</td>
                                                            <td style={{ width: '30%', fontSize: '12px' }}>: {this.props.printData?.[0]?.DonationItemsBatch?.DonationItem?.Donation?.donation_reg_no}</td>
                                                            <td style={{ width: '20%', fontWeight: 'bold', fontSize: '12px' }}>Donation Date</td>
                                                            <td style={{ width: '30%', fontSize: '12px' }}>: {dateParse(this.props.printData?.[0]?.DonationItemsBatch?.DonationItem?.Donation?.createdAt)}</td>
                                                        </tr>
                                                        {/* <tr>
...
export default GRNDonationPrint;