                ...
                <MainContainer>
                    <LoonsCard>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                            <Typography variant="h6" className="font-semibold">Request Details</Typography>
                            <div className='flex'>
                                <Grid
                                    className='pt-3 pr-3'
                                >
                                ...
                                {this.state.loadType ?
                                    <RadioGroup className='px-5' row="row" defaultValue={this.state.type}>
                                        ...
                                        <FormControlLabel onChange={() => { this.changeType('SAMPLE') }} value="SAMPLE" control={<Radio />} label="Sample" />
