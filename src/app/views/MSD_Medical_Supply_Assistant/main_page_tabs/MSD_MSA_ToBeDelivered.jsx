...
class MSD_MSA_ToBeDelivered extends Component {
            ...
            <MainContainer>
                <Grid container="container" spacing={2}>
                    <Grid item="item" xs={12}>
                        <Typography variant="h5" className="font-semibold">Issued Orders</Typography>
                        <Divider />
                    </Grid>
                </Grid>
                {/* {this.state.loaded ?
...
export default MSD_MSA_ToBeDelivered