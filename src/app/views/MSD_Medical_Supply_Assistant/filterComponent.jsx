...
class FilterComponent extends Component {
    ...
    async loadDrugStoreData(search) {
        ...
        let res = await WarehouseServices.getAllWarehousewithOwner({ store_type: ['pharmacy','drug_store'],search:search }, owner_id)
            ...
            <> < ValidatorForm onSubmit={
                () => this
                    ...
                    .onSubmitFunc(
                        ...
                        this.state.formData.district_id,
                ...
                onError={
                    ...
                    <Grid item="item" className="px-2" lg={3} md={3} sm={12} xs={12}>
                        ...
                        <Autocomplete
                            ...
                            options={
                                this.state
                                    .all_district.sort((a,b)=> (a.name?.localeCompare(b.name)))
                            }
                            onChange={(
                                e,
                                value
                    ...
                    <Grid item="item" className="px-2" lg={3} md={3} sm={12} xs={12}>
                        <SubTitle title="Requsted by (Internal)" />
                        <Autocomplete
                                        disableClearable className="w-full" 
                        ...
                        onChange={(e, value) => {
                            ...
                            value={this.state.drugStoreData.find((v) => v.id == this.state.formData.pharmacy)}
                            getOptionLabel={(option) => option.name ? option.name : ''}
                            renderInput={(params) => (
                                <TextValidator {...params} placeholder="Requsted by (Internal)"
                                    //variant="outlined"
                                    onChange={(e)=>{
