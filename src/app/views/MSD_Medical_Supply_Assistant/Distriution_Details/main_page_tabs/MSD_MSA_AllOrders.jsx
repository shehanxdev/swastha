...
class MSD_MSA_AllOrders extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formData: {
                ...
                from_date: null,
                to_date: null,
                status: ['ALLOCATED','APPROVED','COMPLETED','ISSUED','ORDERED','RECIEVED','ALL RECIEVED','REJECTED','Pending','ISSUE SUBMITTED','DISPATCHED'],
                date_type: null,
                from: null,
                district_id: null,
                search: null
            ...
            columns: [
                {
                    ...
                    options: {
                        ...
                        //     if (this.state.data) {
                        //         console.log('statetData', this.state.data)
...
export default MSD_MSA_AllOrders