            ...
            <LoonsCard>
                            ...
                            <Grid item="item" xs={12} sm={12} md={12} lg={12}>
                                <Grid container="container" spacing={2}>
                                    ...
                                    <Grid item="item" xs={12} sm={12} md={4} lg={4}>
                                        <Typography variant="h6" className="font-semibold">You Are On Returning Mode</Typography>
                                    </Grid>
                ...
                <AppBar position="static" color="default">
                    <Tabs
                        ...
                        <Tab label="Returning Mode" {...a11yProps(0)} />
                        <Tab label="Return Requests delivery details" {...a11yProps(1)} />
                        {/* <Tab label="Add Delivery Details" {...a11yProps(2)}/> */}
                    </Tabs>
                </AppBar>
                <TabPanel value={value} index={0} dir={theme.direction}>
                    <ReturnModeTab isOpen={isOpen}></ReturnModeTab>
                </TabPanel>
                <TabPanel value={value} index={1} dir={theme.direction}>
                    <>
                        {/* <ReturnDeliveryDetails></ReturnDeliveryDetails> */}
                        <DeliveryDetailsWarehouse isOpen={isOpen} />
                    </>
                </TabPanel>
                {/* <TabPanel value={value} index={2} dir={theme.direction}>
                    <AddDeliveryDetails isOpen={isOpen} />
                </TabPanel> */}
            </LoonsCard>
        </MainContainer >
    );
