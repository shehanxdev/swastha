...
import { loginUserTypes } from "../../../appconst";
export default function SingleReturnRequest() {
  ...
  useEffect(() => {
    ...
    getRemarks(dispatch)
    getDrugStoreDetails(dispatch, { clinic_id: localStorageService.getItem("Selected_Warehouse")?.pharmacy_drugs_stores_id }, localStorageService.getItem("userInfo").type, localStorageService.getItem("Selected_Warehouse")?.warehouse?.owner_id)
