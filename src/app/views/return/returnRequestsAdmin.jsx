...
import MyAllReturnRequests from "./Tabs/myAllReturnRequestsAdmin";
import MyAllReturnRequestAdminToBeRecieved from "./Tabs/myAllReturnRequestAdminToBeRecieved";
import MyAllReturnRequestAdminAccept from "./Tabs/myAllReturnRequestAdminAccept";
import MyAllReturnRequestAdminReject from "./Tabs/myAllReturnRequestReject";
...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    ...
    if (localStorageService.getItem("Selected_Warehouse")) {
      setWareHouse(localStorageService.getItem("Selected_Warehouse").Warehouse?.name)
    }
              ...
              <Grid item="item" xs={12} sm={12} md={12} lg={12}>
                <Grid container="container" spacing={2}>
                  ...
                  <Grid item="item" xs={12} sm={12} md={4} lg={4}>
                    <Typography variant="h6" className="font-semibold">My All Return Requests (Admin Pharmacist)</Typography>
                  </Grid>
