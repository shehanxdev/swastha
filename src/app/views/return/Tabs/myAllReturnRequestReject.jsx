...
class ReturnMode extends Component {
  ...
  componentDidMount() {
    if (localStorage.getItem("Selected_Warehouse")) {
      let owner_id = localStorageService.getItem("Selected_Warehouse")?.owner_id;
      this.props.getAllReturnRequests({ page: this.state.page, limit: this.state.limit, owner_id: owner_id, status: "ADMIN_REJECT" });
              ...
              <Grid item lg={3} md={3} sm={3} xs={3} className="px-2">
                ...
                &ensp;<Button
                  ...
                  onClick={() => {
                    ...
                    }, () => this.props.getAllReturnRequests({ page: this.state.page, limit: this.state.limit, owner_id: this.state.owner_id, status: "ADMIN_REJECT" }))
                  }}
                >
