...
class ReturnMode extends Component {
  ...
  componentDidMount() {
    if (localStorage.getItem("Selected_Warehouse")) {
      ...
      this.props.getAllReturnRequests({ page: this.state.page, limit: this.state.limit, to: warehouse_id, status: "Pending" });
  ...
  render() {
    ...
    return (
      <MainContainer>
              ...
              <Grid item lg={3} md={3} sm={3} xs={3} className="px-2">
                ...
                &ensp;<Button
                  ...
                  onClick={() => {
                    ...
                    }, () => this.props.getAllReturnRequests({ page: this.state.page, limit: this.state.limit, to: this.state.warehouse_id, status: "Pending" }))
                  }}
                >
        ...
        <Changewarehouse isOpen={this.props.isOpen} type="myAllReturnRequestsTobeRecieved" />
      </MainContainer>
    )
  }
