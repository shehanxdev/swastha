...
class HospitalCreateDistribution extends Component {
    constructor(props) {
        super(props)
        this.state = {
                    ...
                    options: {
                        customBodyRenderLite: (dataIndex) => (
                            <div className='flex'>
                                ...
                                <Tooltip title="Add Item wise ">
                                    <IconButton size="small" color="primary" aria-label="view"
                                        onClick={() => {
                                            window.location = '/RMSD/general/ItemDetailsView/' + this.state.routes_data[dataIndex].warehouse_id
                                            //this.loadStops(this.state.data[dataIndex].id)
...
export default withStyles(styleSheet)(HospitalCreateDistribution)