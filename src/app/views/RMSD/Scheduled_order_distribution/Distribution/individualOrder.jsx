                    ...
                    <Grid item="item" lg={5} md={5} xs={5}>
                        <Grid container="container">
                            <Grid item="item" lg={12} md={12} xs={12}>
                                <Typography variant="h6" className="font-semibold text-center">ON GOING</Typography>
                            </Grid>
                            <Grid item="item" lg={12} md={12} xs={12}>
                                <Grid
                                    container="container"
                                    ...
                                    <Grid item="item" lg={6} md={6} xs={6}>
                                        <Grid container="container">
                                            ...
                                            <Grid item="item" lg={6} md={6} xs={6}>{props.match.params.empname}</Grid>
                                        </Grid>
                                    </Grid>
                                    <Grid item="item" lg={6} md={6} xs={6}><AccountCircleIcon fontSize="large"/></Grid>
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
