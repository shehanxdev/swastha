                                    ...
                                    <Tooltip title='Prescription'>
                                        <IconButton
                                            onClick={() => {
                                                ...
                                                window.location = `/pharmacy/prescription?patient_clinic_id=${selected_data.id}&clinic_id=${this.props.filterData.clinic_id}&patient_id=${selected_data.patient_id}`
...
export default withStyles(styleSheet)(PharmacyPatients)
