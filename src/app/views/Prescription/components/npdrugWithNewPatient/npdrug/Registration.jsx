...
import SearchFromCloud from 'app/views/Patients/SearchFromCloud';
...
class Registration extends Component {
            ...
            if (this.props.usage === "update") {
                ...
                if (res.status == 201) {
                    ...
                    /* console.log("data", data)
                        var url = appConst.PRINT_URL + owner_id + "/patientId.html?";
                       url = url + "institute=" + '';
                    ...
                    this.props.registerdPatient(data)
    ...
    async searchPatientsFromCloud(formData) {
        ...
        if (200 == patientdata.status) {
            if (0 >= patientdata.data.view.totalItems) {
                ...
                this.props.registerdPatient(patientdata.data.view.data[0])
    ...
    async componentDidMount() {
        ...
        let login_user_pharmacy_drugs_stores = await localStorageService.getItem('login_user_pharmacy_drugs_stores')[0];


        //this.bDayFromAge()
        var user = await localStorageService.getItem('userInfo');
        let formData = this.state.formData;
        formData.hospital_id = main_hospital_id;
        formData.pharmacy_drugstore_id = 'f9d7e930-7c38-4bad-904d-9a2634245c88'
        this.setState({ formData })
        if (this.props.usage === "update") {
            await this.loadMOH();
            await this.loadGN();
