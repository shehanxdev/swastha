...
const AddInput = ({ options, onChange = (e) => e, val = "", solo = false, text = "Add", tail = null }) => (<Autocomplete
                                        disableClearable
    options={options}
...
const TableFoot = (props) => {
    ...
    const [params, setParams] = useState([{ id: 1, dosage: null, frequency: null, frequency_val: null, duration: null, remark: null }]);
    ...
    useEffect(() => {
        if (selectedDrug) {
            ...
            setRoute("");
            setDrug("");
            setParams([{ id: 1, dosage: "", frequency: "", frequency_val: "", duration: "", remark: "" }]);
            setRowCount(1)
        }
    }, [selectedDrug]);
            ...
            <div className={classes.medMax}>
                ...
                <Button className={classes.btn} style={{ color: '#06b6d4', background: '#e1fbff' }}
                    onClick={() => {
                        ...
                        setRoute("");
                        setDrug("");
                        setParams([{ dosage: "", frequency: "", frequency_val: "", duration: "", remark: "" }]);
                        select(null);
                    }}>
                    <SaveOutlinedIcon />
                </Button>
