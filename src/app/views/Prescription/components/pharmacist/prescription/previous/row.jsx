...
const Row = (props) => {
    ...
    marginBottomn: 1, }}>
        {
            texts && texts.AssignItems && texts.AssignItems.length > 0 ? texts.AssignItems.map((item,index) => <div key={index} className={classes.row}>
                <div className={classes.col} style={{height:'100%'}}><HoverableText text={texts.ItemSnap.short_description} /></div>
