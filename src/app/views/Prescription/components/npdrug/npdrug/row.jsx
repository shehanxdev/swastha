...
const Row = (props) => {
    ...
    >
        ...
        <div className={classes.even2}><HoverableText text={drug.drug} /></div>
        ...
        <div style={{ width: 'calc(45%)' }}>
            {
                drug.params.map((item, pos) => {
                    return <div style={{ width: '100%', display: 'flex', height: '4em', alignItems: 'center' }}>
                        ...
                        <div className={classes.even}><HoverableText text={moment(item.expectTreatmentDate).format('yyyy-MM-DD')} /></div>
