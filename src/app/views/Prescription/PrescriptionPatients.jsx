...
class PrescriptionPatients extends Component {
    constructor(props) {
        super(props)
        this.state = {
            warning_alert: false,
 ...
 */
            ...
            this.setState({
                ...
                message: res.error
                    ? res.error
                    : 'Clinic patient Registration Unsuccessful',
                warning_alert: false,
                severity: 'error',
            })
        }
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <LoonsDialogBox
                    title="This Patient is Not Registerd in this Clinic"
                    show_alert={true}
                    alert_severity="info"
                    alert_message="Do you want to Register the Patient in to This Clinic?"
                    //message="testing 2"
...
export default withStyles(styleSheet)(PrescriptionPatients)
