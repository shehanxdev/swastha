...
class TECReportSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loading: true,
    ...
    render() {
        return (
            <MainContainer>
                <LoonsCard>
                    <CardTitle title="TEC Evaluation Report Setup" />
