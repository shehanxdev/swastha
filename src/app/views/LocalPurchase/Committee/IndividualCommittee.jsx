...
class IndividualCommittee extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
                        ...
                        <Grid container spacing={2} direction="row">
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12}>
                                ...
                                <Box sx={{ width: '100%', minHeight: '300px', marginTop: '12px' }}>
                                    ...
                                    <TabPanel value={this.state.value} index={0} style={{ p: 3 }}>
                                        <BasicInfo />
                                    </TabPanel>
                                    <TabPanel value={this.state.value} index={1} style={{ p: 3 }}>
                                        <AssignMembers />
                                    </TabPanel>
...
export default withStyles(styleSheet)(IndividualCommittee)
