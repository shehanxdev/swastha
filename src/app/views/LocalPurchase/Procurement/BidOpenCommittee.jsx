...
import CreateAgenda from './BidMinuteAgenda'
...
class BidOpenCommittee extends Component {
    constructor(props) {
        super(props)
        this.state = {
            createAgendas: false,
            ...
            data: [
                {
                    bid_opening_committe_no: "PC/01/20221",
                    date: new Date(),
                    time: new Date(),
                    remarks: "Good",
                    status: "True"
                ...
                {
                    bid_opening_committe_no: "PC/02/20222",
                    date: new Date(),
                    time: new Date(),
                    remarks: "Good",
                    status: "True"
                ...
                {
                    bid_opening_committe_no: "PC/03/20223",
                    date: new Date(),
                    time: new Date(),
                    remarks: "Good",
                    status: "True"
            ...
            columns: [
                {
                    name: 'bid_opening_committe_no',
                    label: 'Bid Opening Committe No',
                    options: {
                        display: true,
                    },
                },
...
export default BidOpenCommittee
