...
const Row = (props) => {
    ...
    >
        ...
        <div className={classes.max}><HoverableText text={dateParse(drug.date)} /></div>
        <div className={classes.max}><HoverableText text={drug.srNo} /></div>
        <div className={classes.medMax}><HoverableText text={drug.itemName} /></div>
        <div className={classes.medMax}><HoverableText text={drug.review} /></div>
        <div className={classes.medMax}><HoverableText text={drug.comment} /></div>
        <div className={classes.medMax}><Rating name="read-only" defaultValue={drug.rating} readOnly /></div>
