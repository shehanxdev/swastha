...
const Row = (props) => {
    ...
    >
        ...
        <div className={classes.medMax}><HoverableText text={drug.brandName} /></div>
        <div className={classes.medMax}><HoverableText text={drug.agentName} /></div>
        {/* <div className={classes.medMax}><HoverableText text={`${drug.dosserNo} mg`} /></div> */}
        <div className={classes.medMax}><HoverableText text={`LKR ${drug.price}`} /></div>
