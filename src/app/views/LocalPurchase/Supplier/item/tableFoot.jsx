...
const TableFoot = (props) => {
    ...
    // const [dosserNo, setDosserNo] = useState(null);
    ...
    useEffect(() => {
        if (selectedDrug) {
            ...
            setBrandName(selectedDrug.brandName);
            setAgentName(selectedDrug.agentName);
            // setDosserNo(selectedDrug.dosserNo);
    ...
    return <div className={classes.footerContainer}>
        <div className={classes.tbleFooter}>
            ...
            <div className={classes.medMax}>
                <AddTextInput text="Brand Name" val={brandName ? brandName : ""} onChange={(e) => {
                    setBrandName(e.target.textContent ? e.target.textContent : e.target.value);
                }} />
            </div>
            <div className={classes.medMax}>
                <AddTextInput text="Agent Name" val={agentName ? agentName : ""} onChange={(e) => {
                    setAgentName(e.target.textContent ? e.target.textContent : e.target.value);
                }} />
            </div>
            {/* <div className={classes.medMax}>
                ...
                <Button className={classes.btn} style={{ color: '#06b6d4', background: '#e1fbff' }}
                    onClick={() => {
                        ...
                        if (selectedDrug !== null) {
                            ...
                            arr[index].brandName = brandName;
                            arr[index].agentName = agentName;
                            arr[index].price = price;
                        }
                        else {
                            if (srNo !== null && itemName !== null && drugID !== null && brandName !== null && agentName !== null && price !== null) {
                                arr.push({ drugID: drugID, srNo: srNo, itemName: itemName, brandName: brandName, agentName: agentName, price: price });
                            } else {
                                setOpen(true);
                            }
                        }
