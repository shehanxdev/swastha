...
class CurrentYearSupplier extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
            data: [
                {
                    deviceName: "Panadol",
                    dvrNo: "IT101",
                    dateRecieved: dateParse(new Date()),
                    brandName: "Atrolip",
                    manufacturer: "Nimal",
                    country: "Japan",
                    agent: "Nikmal",
                    dateOfReg: dateParse(new Date()),
                    expDate: dateParse(new Date()),
                    certificateNo: "C1001"
                }
            ],
            columns: [
                {
                    name: 'deviceName', // field name in the row object
                    label: 'Device Name', // column title that will be shown in table
                    options: {
                        filter: false,
                        display: true,
                    },
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <IconButton
                                    ...
                                    onClick={() => { window.location = '/localpurchase/supplier_surgical/123' }}
                                >
...
export default withStyles(styleSheet)(CurrentYearSupplier)