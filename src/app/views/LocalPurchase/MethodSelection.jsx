        ...
        return (
            <Fragment>
                <MainContainer>
                    {/* Filtr Section */}
                    <LoonsCard>
                        <CardTitle title="Local Purchase Method Selection" />
                        {/* Main Grid */}
                                    ...
                                    <Grid container spacing={2}>
                                                    ...
                                                    >
                                                        <Grid container spacing={2}>
                                                            ...
                                                            <Grid
                                                                ...
                                                                xs={12}
                                                            >
                                                                {renderSubsequentDetailCard('Requseted Date :', dateParse(new Date()))}
                                                            </Grid>
                                                        </Grid>
                                                    </Grid>
                                                    <br />
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid
                                                ...
                                                lg={12}
                                            >
                                                <SubTitle title="Method Selection" />
                                                <Divider className='mt-2' />
                                            </Grid>
                                            <Grid item lg={12} md={12} sm={12} xs={12} className='w-full' style={{ marginLeft: "24px" }}>
                                                <Grid container spacing={2}>
                                                    <Grid
                                                        className=" w-full"
                                                        item
                                                    ...
                                                    >
                                                        <Grid container spacing={2}>
                                                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                                                <SubTitle title="If Shopping Method :" />
                                                            </Grid>
                                                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                                                <Button
                                                                    style={{ minWidth: "200px", justifyContent: "flex-start", paddingLeft: "18px" }}
                                                                    // className="mt-2"
                                                                    progress={false}
                                                                    type="submit"
                                                                    scrollToTop={
                                                                    ...
                                                                    onClick={() => {
                                                                        window.location = `/localpurchase/method_selection/123`
                                                                    }}
                                                                >
                                                    ...
                                                    >
                                                        <Grid container spacing={2}>
                                                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                                                <SubTitle title="If Procurement Method :" />
                                                            </Grid>
                                                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                                                <Button
...
export default withStyles(styleSheet)(MethodSelection)
