...
class LPQuotationView extends Component {
    ...
    loadData = async () => {
        ...
        if (res.status === 200) {
            console.log('selected dupplire' , res)
    ...
    componentDidMount() {
        ...
        if (id) {
            this.setState({ id: id }, () => {
                this.loadData()
                this.getUser()
                // this.getSupplierID(this.props.lpID)
    ...
    componentDidUpdate(prevProps) {
        const { delivery, closingDate, selected, sampleDate, id, lpReqId, lpSupplierInfo } = this.props;

        console.log("Print: ", { delivery, closingDate, selected, sampleDate, id, lpReqId, lpSupplierInfo })
        ...
        // if (lpSupplierInfo !== prevProps.lpSupplierInfo) {
        //     this.getSupplierID(lpSupplierInfo)
        // }
    }
                    ...
                    <Grid container>
                        ...
                        <Grid className="mt-5" item sm={12}>
                            <table style={{ width: "100%" }}>
                                ...
                                <tr>
                                    <td style={{ fontWeight: "bold", width: "25%" }}>Selected Supplire</td>
