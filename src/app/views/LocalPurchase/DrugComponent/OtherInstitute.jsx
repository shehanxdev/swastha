...
class OtherInstitute extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
                        ...
                        <Grid container spacing={2}>
                            ...
                            >
                                ...
                                <Autocomplete
                                    ...
                                    //         // formData.type = value.id
                                    //         let suggestedWareHouses = this.state.suggestedWareHouses;
                                    //         suggestedWareHouses.type = value.id;
                            ...
                            <Grid
                                ...
                                xs={12}
                            >
                                <SubTitle title="Line Ministry / Provincial" />
                                ...
                                <Autocomplete
                                    ...
                                    // if (value != null) {
                                    //     let suggestedWareHouses = this.state.suggestedWareHouses;
                                    //     suggestedWareHouses.pharmacy = value.id;
                                    ...
                                    //     }}
                                    renderInput={(params) => (
                                        <TextValidator {...params} placeholder="Line Ministry / Provincial"
                                            //variant="outlined"
                                            fullWidth="fullWidth" variant="outlined" size="small"
                                        // onInput={(e) => {
...
export default withStyles(styleSheet)(OtherInstitute)
