...
import { CircularProgress, Grid, Link, Tooltip, IconButton ,InputAdornment , Dialog,
      DialogActions,
      DialogContent,
      DialogTitle, Icon, } from "@material-ui/core";
...
class HigherLevelDS extends Component {
    ...
    async loadData() {
        ...
        let owner_id = null
        let allDataStorePharmacy = await PharmacyService.fetchAllDataStorePharmacy(owner_id, {issuance_type:['drug_store','Drug Store','Main', 'RMSD Main']})
                ...
                <MainContainer>
                        ...
                        <Grid item lg={12} className=" w-full ">
                            ...
                            >
                                ...
                                >
                                    <span className="capitalize">Add Drugstore</span>
                                </Button>
                            </Grid>
...
export default withStyles(styleSheet)(HigherLevelDS)
