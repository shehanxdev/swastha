                                    ...
                                    <Tooltip title="View">
                                        <IconButton
                                            ...
                                            onClick={() => {
                                                ...
                                                let selectUnit = this.state.data[tableMeta.rowIndex]
                                                window.location.href=`/hospital-data-setup/create-new-unit/${this.state.data[tableMeta.rowIndex].id}` + "?owner_id=" + this.state.owner_id + "&type=" + selectUnit.Department.name + "&name=" + selectUnit.name + "&clinic_no_prefix=" + selectUnit.clinic_no_prefix + "&store_id=" + selectUnit.store_id;
 ...
 handleUpdate = (val) => {
    ...
    async saveUnit() {
        ...
        if (201 == res.status) {
            ...
            this.setState({
                alert: true,
                message: 'Unit creation was Unsuccessful',
                severity: 'error',
            })
        }
    }
     ...
     async updateUnit() {
        ...
        if (res.status) {
            this.setState({
                alert: true,
                message: 'Unit update Successfuly',
                severity: 'success',
            }, () => {
                // this.loadData()
                  window.location.reload()
            ...
            this.setState({ alert: true, message: "Unit Update Unsuccessful", severity: 'error' })
        }
    }
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Add New Unit" />

                        <div className="w-full">
                            <ValidatorForm
                                className="pt-2"
                                onSubmit={() => this.state.buttonName == "Save" ? this.saveUnit() : this.updateUnit()}
                            ...
                            :null}
                                    ...
                                    >
                                        ...
                                        disableClearable
                                            ...
                                            //             .department_id
                                            // )}
                                            value={{name:this.state.formData.unit_type}}

                                          /*   value={
                                                {
                                                    name: this.state.formData.ward_type,
                                                    id:this.state.formData.department_id,
                                                }
                                            } */
                                            getOptionLabel={(option) =>
                                                option.name ? option.name : ''
                                    ...
                                    <Grid
                                        ...
                                        xs={12}
                                    >
                                        <SubTitle title="Unit ID" />

                                        <TextValidator
                                            className=" w-full"
                                            placeholder="Ex:UNIT000001"
                                            name="store_id"
...
export default withStyles(styleSheet)(Unit)
