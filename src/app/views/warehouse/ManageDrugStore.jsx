...
class ManageDrugStore extends Component {
    constructor(props) {
        super(props)
                ...
                <MainContainer>
                    <Grid container spacing={1} className="flex">
                        <Grid
                            ...
                            className=" w-full"
                        >
                            <CardTitle title="Manage Drugstore" />
                        </Grid>
                                                                ...
                                                                <Button
                                                                    ...
                                                                    onClick={() => {
                                                                        this.props.history.push(
                                                                            '/warehouse/drug-store/assign-drugs',
...
export default withStyles(styleSheet)(ManageDrugStore)
