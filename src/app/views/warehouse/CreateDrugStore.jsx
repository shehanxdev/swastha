...
class CreateDrugStore extends Component {
    constructor(props) {
        super(props)
        this.state = {
            allDepartmentTypes: [],
    ...
    async saveStepOne() {
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Drug Store Created Successfuly',
                severity: 'success',
            }, () => {
            ...
            this.setState({
                alert: true,
                message: 'Drug Store creation was Unsuccessful',
                severity: 'error',
            })
        }
    }
...
export default withStyles(styleSheet)(CreateDrugStore)
