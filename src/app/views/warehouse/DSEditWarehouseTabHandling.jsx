...
import DSWarehouseBins from './DSWarehouseBins'
// import CreateWarehousePeople from './CreateWarehouse/CreateWarehousePeople'
import DSCreateWarehouseList from './DSCreateWarehouseList'
                                    ...
                                    <Fragment>
                                        {
                                            this.state.activeTab == 0 ?
                                                <div className='w-full'>
                                                    <DSWarehouseBins id ={this.props.match.params.id} pharmacydrugstore ={this.state.data.Pharmacy_drugs_store}  />
                                                </div> : null
                                        }
                                        {
                                            this.state.activeTab == 1 ?
                                                <div className='w-full'>
                                                    <DSCreateWarehouseList id ={this.props.match.params.id} pharmacydrugstore = {this.state.data.Pharmacy_drugs_store}/>
                                                </div> : null
                                        }
                                          {/* {
