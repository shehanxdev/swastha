...
class WarehouseBins extends Component {
        ...
        if(rowData.temparature_range == null){
            this.setState({
                ...
                formData: {
                    ...
                    temp_from:rowData.temparature_ranges,
                    temp_to:rowData.temparature_ranges,
            ...
            this.setState({
                ...
                formData: {
                    bin_id: rowData.bin_id,
                    bin_type_id: rowData.bin_type_id,
                    temp_from:temparature_ranges[0],
                    temp_to:temparature_ranges[1],
                    // temparature_range: rowData.temparature_range,
                    width: rowData.width,
                    height: rowData.height,
                    length: rowData.length,
    ...
    handleDataSubmit = async () => {
        ...
        let res
        if (this.state.isUpdate) {
            res = await WarehouseServices.updateWarehouseBins(this.state.id, formData)

            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Default Route Successfully Updated',
                    severity: 'success',
                ...
                this.setState({
                    alert: true,
                    message: 'Default Route Updated Unsuccessful',
                    severity: 'error',
                })
            }
            ...
            //save function
            res = await WarehouseServices.createDefaultRoute(formData)
            ...
            if (201 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Default Route Successfully Stored',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Default Route Registration Unsuccessful',
                    severity: 'error',
                })
            }
        }
    ...
    async fetchDataSet() {
        ...
        const res = await WarehouseServices.getAllWarehouseBins(filterData,"000")
    ...
    handleDataSubmit = async () => {
        ...
        let res
        if (this.state.isUpdate) {
            res = await WarehouseServices.updateDefaultRoute(this.state.id, formData)

            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Warehouse Bin Successfully Updated',
                    severity: 'success',
                ...
                this.setState({
                    alert: true,
                    message: 'Warehouse Bin Updated Unsuccessful',
                    severity: 'error',
                })
            }
                                    ...
                                    >
                                        ...
                                        disableClearable
                                                        ...
                                                        onChange={(e, value) => {
                                                            if (value != null) {
                                                                let formData = this.state.formData;
                                                                formData.bin_type_id = value.id
                                                                // formData.sr_no = this.state.group_code + value.code + this.state.item_post_fix

                                                                this.setState({
                                                                    formData, 
                                                                    bin_type_id: value.code })

                                                            }
                                                        }}
                                                        value={this.state.allBinTypes.find((obj) => obj.id == this.state.formData.bin_type_id
                                                        )}
                                                ...
                                                >
                                                    ...
                                                    <TextValidator
                                                        ...
                                                        onChange={(e) => {
                                                            let formData = this.state.formData;
                                                            formData.temparature_range = this.state.temp_from +"-"+  this.state.temp_to
