...
import PharmacyHigherLevel from './PharmacyHigherLevel'
...
class CreateNewOPD extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            empType: [
                ...
                {
                    type: 'OPD Admin', lable: 'OPD Admin'
                }
            ],
            empFormData: {
                employee_id: "",
    ...
    async createClinicDays() {
        ...
        if (res.status === 201) {
            this.setState({
                alert: true,
                message: 'OPD day created successfully!',
                severity: 'success',
                conformingClinicDialog: false
            }, () => {
                this.loadData()
            ...
            this.setState({
                alert: true,
                message: 'OPD day created was unsuccessful!',
                severity: 'error',
            })
        }
    }
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title={this.state.data.name + "\tOPD"} />
                            ...
                            >
                                <Grid container spacing={1} className="flex ">
                                    ...
                                    <Grid
                                        ...
                                        xs={12}
                                    >
                                        <SubTitle title="OPD number suffix" />
                                    ...
                                    {/* <Grid style={{ marginTop: 20 }}>
                                        < LoonsCard>
                                            ...
                                            >
                                                ...
                                                >
                                                    <span className="capitalize">Add OPD day</span>
                                                </Button>
                                            </Grid>
