...
class ChildWarehouse extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loaded: true,
                              ...
                              return (
                                  <Grid className="flex items-center">
                                       <Tooltip title="Edit">
                                          <IconButton
                                                  onClick={() => {
                                                      window.location.href = `/warehouse/editwarehousetab/${id}`
    ...
    render() {
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title=" Child-Warehouse List " />
