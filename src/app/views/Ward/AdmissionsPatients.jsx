...
class AdmissionsPatients extends Component {
    constructor(props) {
        super(props)
        this.state = {
            drawerOpen: true,
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <Grid className='flex items-center'>
                                    <Tooltip title='Admit'>
                                        <IconButton
                                            disabled={(this.state.data[tableMeta.rowIndex].status == 'Admitted') || (this.state.data[tableMeta.rowIndex].status == 'Discharged') ||(this.state.data[tableMeta.rowIndex].status=='Shared Care')}
                                            onClick={() => {
                                                console.log('clicked')
                                        ...
                                        >
                                            <PersonAddIcon
                                                style={{ color: ((this.state.data[tableMeta.rowIndex].status == 'Admitted') || (this.state.data[tableMeta.rowIndex].status == 'Discharged')||(this.state.data[tableMeta.rowIndex].status=='Shared Care')) ? "#bdbdbd" : "#FFAF38" }}
                                            />
                                        </IconButton>
                                    </Tooltip>
                                    <Tooltip title='Transfer'>
                                        <IconButton
                                            disabled={(this.state.data[tableMeta.rowIndex].status == 'Pending')||(this.state.data[tableMeta.rowIndex].status == 'Active') /* || (this.state.data[tableMeta.rowIndex].status == 'Transfer') */ || (this.state.data[tableMeta.rowIndex].status == 'Discharged')||(this.state.data[tableMeta.rowIndex].status=='Shared Care')}
                                            onClick={() => {
                                                console.log('clicked')
                                                let selected_data = this.state.data[tableMeta.rowIndex]
                                                console.log('clicked', selected_data)
                                    ...
                                    <Tooltip title='Discharge'>
                                        <IconButton
                                            disabled={(this.state.data[tableMeta.rowIndex].status == 'Discharged')||(this.state.data[tableMeta.rowIndex].status == 'Active') ||(this.state.data[tableMeta.rowIndex].status == 'Pending') }
                                            onClick={() => {
                                                console.log('clicked')
                                                let selected_data = this.state.data[tableMeta.rowIndex]
                                                console.log('clicked', selected_data)
                                        ...
                                        >
                                            <CancelIcon
                                                style={{ color: ((this.state.data[tableMeta.rowIndex].status == 'Discharged')||(this.state.data[tableMeta.rowIndex].status == 'Active')||(this.state.data[tableMeta.rowIndex].status == 'Pending') ) ? "#bdbdbd" : "#FF3D57" }}
...
export default withStyles(styleSheet)(AdmissionsPatients)
