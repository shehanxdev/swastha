            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        <LocalShipment data={this.state.single_data} isEdit={false} handleClose={() => this.setState({ approveOpen: false })} submitOpen={() => this.setState({ approveOpen: false })} handleReject={() => this.setState({ rejectOpen: true })} />
                    </div>
                </Dialog>
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        <DialogContent>
                            <DialogContentText id="alert-dialog-description">
                                Are you Sure to forward the LDCN?
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <Button onClick={() => {
                ...
                <Dialog fullWidth="fullWidth"
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        <DialogContent>
                            <DialogContentText id="alert-dialog-description">
                                Are you Sure you want to reject the LDCN?
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <Button onClick={() => {
