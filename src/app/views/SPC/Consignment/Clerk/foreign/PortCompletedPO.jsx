            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        {/* {this.state.sequence === 0 ? */}
                        <ForeignShipment data={this.state.single_data} isEdit={false} handleClose={() => this.setState({ approveOpen: false })} submitOpen={() => this.setState({ approveOpen: false })} handleReject={() => this.setState({ rejectOpen: true })} />
                        {/* //     :
...
export default withStyles(styleSheet)(CompletedPO)
