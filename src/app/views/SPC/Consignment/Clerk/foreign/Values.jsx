                                            ...
                                            <Grid item lg={12} md={12} sm={12} xs={12} className='px-4 py-4' style={{ borderRadius: "10px", backgroundColor: "#3B71CA", margin: "0 8px" }}>
                                                ...
                                                >
                                                    <div style={{ display: "flex", flexDirection: "row" }}>
                                                        <div style={{ flex: 1 }}>
                                                            {renderDetailCard('Order Total', `${this.state.filterData?.currency ? this.state.filterData?.currency : ''} ${convertTocommaSeparated(this.state.orderExchageTotal, 2)}`)}
                                                        </div>
                                                        <div style={{ flex: 1 }}>
                                                ...
                                                >
                                                    <div style={{ display: "flex", flexDirection: "row" }}>
                                                        <div style={{ flex: 1 }}>
                                                            {renderDetailCard('Transit Total', `${this.state.filterData?.currency ? this.state.filterData?.currency : ''} ${convertTocommaSeparated(this.state.transitExchageTotal, 2)}`)}
                                                        </div>
                                                        <div style={{ flex: 1 }}>
                                                ...
                                                >
                                                    <div style={{ display: "flex", flexDirection: "row" }}>
                                                        <div style={{ flex: 1 }}>
                                                            {renderDetailCard('Allocated Total', `${this.state.filterData?.currency ? this.state.filterData?.currency : ''} ${convertTocommaSeparated(this.state.allocatedExchangeTotal, 2)}`)}
                                                        </div>
                                                        <div style={{ flex: 1 }}>
                                                ...
                                                >
                                                    <div style={{ display: "flex", flexDirection: "row" }}>
                                                        <div style={{ flex: 1 }}>
                                                            {renderDetailCard('Remaining Total', `${this.state.filterData?.currency ? this.state.filterData?.currency : ''} ${convertTocommaSeparated(Math.max(this.state.orderExchageTotal - this.state.allocatedExchangeTotal - this.state.transitExchageTotal, 0), 2)}`)}
                                                        </div>
                                                        <div style={{ flex: 1 }}>
