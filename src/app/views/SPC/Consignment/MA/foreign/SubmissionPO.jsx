...
class SubmissionPO extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <p>{this.state.data[tableMeta.rowIndex]?.updatedAt ? dateParse(this.state.data[tableMeta.rowIndex]?.updatedAt) : 'N/A'}</p>
                            )
                        }
                    },
                },
    ...
    onSubmit = async (status, remark, data) => {
        ...
        try {
            ...
            let approval_res = await SPCServices.changeConsignmentApproval(data?.id, params)
            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4">
                        ...
                        {/* {this.state.sequence === 0 ? */}
                        <ForeignDetails isEdit={this.state.userRoles.includes('SPC MA')} isResubmit={false} data={this.state.single_data} id={this.state.selected_id} handleClose={() => this.setState({ approveOpen: false })} onSubmit={(status, remark, data) => { this.onSubmit(status, remark, data) }} handleReject={() => this.setState({ rejectOpen: true })} />
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        <DialogContent>
                            <DialogContentText id="alert-dialog-description">
                                Are you Sure to forward the WDN?
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <Button onClick={() => {
                ...
                <Dialog fullWidth="fullWidth"
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        <DialogContent>
                            <DialogContentText id="alert-dialog-description">
                                Are you Sure you want to reject the WDN?
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <Button onClick={() => {
...
export default withStyles(styleSheet)(SubmissionPO)
