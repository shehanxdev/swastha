            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        ...
                        // filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return <p>{this.state.itemList[tableMeta.rowIndex]?.allocated_quantity ? this.state.itemList[tableMeta.rowIndex]?.allocated_quantity : "Not Available"}</p>
                        }
                    },
                },
                {
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item lg={12} md={12} sm={12} xs={12} className='px-4 py-4' style={{ borderRadius: "10px", backgroundColor: "#3B71CA", margin: "0 8px" }}>
                                                ...
                                                >
                                                    <div style={{ display: "flex", flexDirection: "row" }}>
                                                        <div style={{ flex: 1 }}>
                                                            {renderDetailCard('Remaining Total', `LKR ${convertTocommaSeparated(this.state.orderLKRTotal - this.state.allocatedLKRTotal, 4)}`)}
                                                        </div>
                                                        <div style={{ flex: 1 }}>
