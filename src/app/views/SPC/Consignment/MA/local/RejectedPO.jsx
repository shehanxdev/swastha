            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4">
                        {/* {this.state.sequence === 0 ? */}
                        <LocalDetails isEdit={this.state.userRoles.includes("SPC MA")} id={this.state.selected_id} isResubmit={true} data={this.state.single_data} isApprove={this.state.isApprove} handleClose={() => this.setState({ approveOpen: false }, () => { this.loadData() })} onSubmit={(status, remark, data) => { this.onSubmit(status, remark, data) }} handleReject={() => this.setState({ rejectOpen: true })} />
