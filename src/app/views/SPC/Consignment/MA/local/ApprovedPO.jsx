...
class ApprovedPO extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4">
                        {/* {this.state.sequence === 0 ? */}
                        <LocalDetails isEdit={false} isResubmit={false} data={this.state.single_data} id={this.state.selected_id}
                            handleClose={() => {
                                this.setState({ approveOpen: false }, () => {
                                    this.loadData()
                                })
...
export default withStyles(styleSheet)(ApprovedPO)
