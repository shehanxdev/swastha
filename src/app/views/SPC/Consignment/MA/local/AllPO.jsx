    ...
    async printData(id) {
        try {
            ...
            this.setState({
                ...
                console.error("consigmnet Data on", po_res_single.data.view);
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                {this.state.ploaded &&
                    <LDCNPrint purchaseOrderData={this.state.purchaseOrderData} POData={this.state.POData} ItemData={this.state.itemList} hospital={this.state.hospital} user={this.state.user} deliveryData={this.state.deliveryData} onClose={() => this.loadData()} />
                }
                <Dialog
                    fullWidth={true}
                    maxWidth="xl"
                    ...
                    <MuiDialogTitle disableTypography="disableTypography" className={classes.Dialogroot}>
                        ...
                        {/* :
                            <CardTitle title="LDCN Individual Port Details" />
                        } */}
                    ...
                    <div className="w-full h-full px-4">
                        {/* {this.state.sequence === 0 ? */}
                        <LocalDetails isEdit={false} isResubmit={false} data={this.state.single_data} id={this.state.selected_id} handleClose={() => { this.setState({ approveOpen: false }, () => this.loadData()) }} onSubmit={(status, remark, data) => { this.onSubmit(status, remark, data) }} handleReject={() => this.setState({ rejectOpen: true })} />
