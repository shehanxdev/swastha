...
class PendingDebitNotes extends Component {
    ...
    loadData = async () => {
        ...
        const formData = { ...this.state.filterData, type: "SPC LC Debit Note" }

        let res = await SPCServices.getAllDebitNotes(formData)

        if (res.status == 200) {
            console.log('LDCN Data --->>', res);
            ...
            <Fragment>
                                        ...
                                        {/* <Grid item className='w-full' lg={12} md={12} sm={12} xs={12}>
                                            <Grid container spacing={2}>
                                                <Grid
                                                    ...
                                                    xs={12}
                                                >
                                                    <SubTitle title="LDCN Ref No" />
                                                    <TextValidator
                                                        className=" w-full"
                                                        placeholder="Enter LDCN Ref Number"
                                                        name="ldcn_ref_no"
                                                        InputLabelProps={{
                                                            shrink: false,
                                                        }}
                                            ...
                                            <div style={{ display: "flex", flexDirection: "row" }}>
                                                <div style={{ flex: 1 }} className='mr-2'>
                                                    <DatePicker
                                                        className="w-full"
                                                        value={
                                                            this.state.filterData.ldcn_from
                                                        }
                                                        //label="Date From"
                                                        placeholder="From"
                                                        // minDate={new Date()}
                                        ...
                                        >
                                            ...
                                            <AddInput
                                                ...
                                                onChange={(e, value) => {
                                                    const newFormData = {
                                                        ...this.state.filterData,
                                                        shipment_status: e.target.textContent ? e.target.textContent : e.target.value,
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        ...
                        {/* 
                                <PendingDebitNoteDetailsView editAccess={false} sequence={this.state.sequence} selected_data={this.state.selected_id} storeData={this.handleDataStore} handleReject={() => this.setState({ rejectOpen: true })} handleClose={() => this.setState({ viewDet: false })} submitOpen={() => this.setState({ forwardOpen: true })} />
