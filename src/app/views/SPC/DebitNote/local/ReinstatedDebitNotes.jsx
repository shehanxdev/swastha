...
class ReinstatedDebitNotes extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <p>{dateParse(this.state.data[tableMeta.rowIndex]?.Consignment?.debit_note_date)}</p>
                            )
                        }
                    },
                },
...
export default withStyles(styleSheet)(ReinstatedDebitNotes)
