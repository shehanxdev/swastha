...
import LocalDetails from "./local/ApprovalDetails"
import DelailsView from "./local/ApprovalDetailsView"
...
class LCDNDetails extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
            ...
            columns: [
                ...
                {
                    name: 'ldcn_ref_no', // Shipment is comes in ldcn_ref_no
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                <p>{this.state.data[tableMeta.rowIndex]?.ldcn_date ? dateParse(this.state.data[tableMeta.rowIndex]?.ldcn_date) : 'Not Available'}</p>
                            )
                        }
                    },
                },
...
export default withStyles(styleSheet)(LCDNDetails)
