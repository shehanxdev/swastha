...
class IndividualDetails extends Component {
    ...
    loadData = async () => {
        ...
        if (this.props.data) {
            ...
            filterData.wharf_ref_no = this.props.data?.wharf_ref_no
            filterData.wdn_no = this.props.data?.wdn_no
            filterData.wdn_date = this.props.data?.wdn_date
    ...
    async getSingleItemDet() {
        let res = await SPCServices.getConsignmentbyId({}, this.props.data.id)

        if (res.status === 200) {
            console.log('cheking single data', res)

            this.setState({ transaction_data: res.data.view.ConsigmentCharges })
        }
    }
    ...
    async getDebitNoteSubType() {
        ...
        if (res.status === 200) {
            console.log('debit note type sub: ', res);
            this.setState({
    ...
    confirm() {
        this.setState({ conformation_dialog: true, })
    }
    ...
    async getTransactionDet() {
        ...
        if (res.status === 200) {
            ...
            // let ssl = res.data.view.data.filter((e)=>e?.TransactionType?.type === 'SSL')

            let service_vat = res.data.view.data.filter((e) => e?.TransactionType?.type === 'Service VAT')
            ...
            let service_vat_charge
            console.log("check 03")
            for (const vatItem of service_vat) {

                service_vat_charge = roundDecimal((vatItem?.value * service_charge) / 100, 2)
                service_vat_data.push({
                    transaction_type: vatItem?.TransactionType?.type,
                    transaction_type_id: vatItem?.TransactionType?.id || null,
                    percentage_or_value: vatItem?.value || 0,
                    value: service_vat_charge,
                    is_percentage: vatItem?.is_percentage
                });
            }
            ...
            console.log("service_vat_data 0", service_vat_data)
            console.log("additional_data", additional_data)
            console.log("additionalData", additionalData)

            this.setState({
                service_val: service_data,
                service_vat_val: service_vat_data,
    ...
    async saveDebitNote() {
        ...
        let newDataArray3 = this.state.service_vat_val;
        let newDataArray4 = this.state.additional_val;

        // const finishObject = newDataArray1.concat(newDataArray2);
        // const finishObject1 = newDataArray1.concat(newDataArray3);
        // const finishObject2 = newDataArray1.concat(newDataArray4);
        const finishObject = [...newDataArray1, ...newDataArray2, ...newDataArray3, ...newDataArray4]
        // const finalcombinedObject = combinedObject.concat(newDataArray3);
        // const finishObject = combinedObject.concat(combinedObject);
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        >
                                            ...
                                            <AddTextInput
                                                ...
                                                val={this.state.filterData?.wharf_ref_no}
                                                text='Enter Shipment No' type='text'
                                            />
                                        </Grid>
                                        <Grid
                                            className=" w-full"
                                        ...
                                        >
                                            ...
                                            <AddTextInput
                                                ...
                                                disabled={true}
                                                val={this.state.filterData?.shipment_no} text='Enter LDCN Number' type='text' />
                                        </Grid>
                                        <Grid
                                            className=" w-full"
                                            item
                                        ...
                                        >
                                            ...
                                            <AddInputDate
                                                ...
                                                // }} 
                                                disabled
                                                val={dateParse(this.state.filterData?.wdn_date)} text='Enter LDCN Date' />
                                        </Grid>
                                        ...
                                        >
                                            ...
                                            <AddTextInput
                                                ...
                                                disabled={true}
                                                val={this.state.filterData?.indent_no} text='Enter Indent Number' type='text' />
                                        </Grid>
                                        <Grid
                                            className=" w-full"
                                            item
                                                    ...
                                                    <Fragment>
                                                        ...
                                                        <Grid container spacing={2}>
                                                            ...
                                                            >
                                                                ...
                                                                <div style={{ display: "flex", flexDirection: "row", alignItems: "center", height: "40px" }}>
                                                                    ...
                                                                    text='Enter Service Percentage' type='number' /> */}
                                                                        <TextValidator
                                                                            ...
                                                                            size="small"
                                                                            value={this.state.service_val[0]?.percentage_or_value}
                                                                ...
                                                                {this.state.service_vat_val.length > 0 &&
                                                                    <div style={{ display: "flex", flexDirection: "row", alignItems: "center", height: "40px" }}>

                                                                        <div style={{ flex: 1 }}>
                                                                            <SubTitle title={this.state.service_vat_val[0]?.transaction_type} />
                                                                        </div>
                                                                        <div style={{ flex: 1 }} className='mx-2'>
                                                                            <TextValidator
                                                                                onChange={(e) => {
                                                                                    // let service_vat_val.percentage_or_value = 15;
                                                                                    let cal = (this.state.service_val[0].value * e.target.value) / 100
                                                                                    // let cal2 = ((Number(this.state.filterData?.invoice_amount) + Number((this.state.filterData?.invoice_amount * e.target.value)/100) ) * this.state.vat_val[0]?.percentage_or_value)/100

                                                                                    let service_vat_val = this.state.service_vat_val
                                                                                    service_vat_val[0].percentage_or_value = e.target.value
                                                                                    service_vat_val[0].value = cal

                                                                                    // let vat_val = this.state.vat_val
                                                                                    // vat_val[0].percentage_or_value = this.state.vat_val[0]?.percentage_or_value
                                                                                    // vat_val[0].value = cal2
                                                                                    console.log("invoice_amount", this.state.service_vat_val);
                                                                                ...
                                                                                size="small"
                                                                                value={this.state.service_vat_val[0]?.percentage_or_value}
                                                                                text="Enter Service Percentage"
                                                                                variant="outlined"
                                                                                type="number"
                                                                            // disabled = {true}
                                                                        ...
                                                                        <div style={{ flex: 1 }} className='mx-2'>
                                                                            <TextValidator
                                                                                onChange={(e) => {
                                                                                    // let service_vat_val = this.state.service_vat_val
                                                                                    //     service_vat_val[0].value = e.target.value
                                                                                    // service_vat_val[0].value = cal
                                                                                ...
                                                                                size="small"
                                                                                disabled
                                                                                value={roundDecimal((this.state.service_val[0]?.value * this.state.service_vat_val[0]?.percentage_or_value) / 100, 4)}
                                                                                text='Enter Service Amount'
                                                                                variant="outlined"
                                                                                type='number' />
                                                                            <p className='hidden'>{total_value = total_value + ((this.state.service_val[0]?.value * this.state.service_vat_val[0]?.percentage_or_value) / 100)}</p>
                                                                        </div>
                                                        ...
                                                        >
                                                            ...
                                                            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", height: "40px" }}>
                                                                ...
                                                                <div style={{ flex: 1 }} className='mx-2'>
                                                                    ...
                                                                    size="small"
                                                                    value={roundDecimal(((Number(this.state.filterData?.invoice_amount) + Number((this.state.filterData?.invoice_amount * this.state.service_val[0]?.percentage_or_value)/100) ) * this.state.vat_val[0]?.percentage_or_value)/100, 2)} 
                                                                    text='Enter Service Amount' 
                                                                    variant="outlined"
                                                                    disabled
                                                                    type='number' />
                                                        ...
                                                        >
                                                            ...
                                                            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", height: "40px" }}>
                                                                ...
                                                                <div style={{ flex: 1 }}>
                                                                    <SubTitle title={this.state.ssl_val[0]?.transaction_type} />
                                                                </div>
                                                                <div style={{ flex: 1 }} className='mx-2'>
                                                                    <AddNumberInput 
                                                                    onChange={(e) => {
                                                                        ...
                                                                        let ssl_val = this.state.ssl_val
                                                                        ssl_val[0].percentage_or_value = e.target.value
                                                                        ssl_val[0].value = cal
                                                                    ...
                                                                    val={this.state.ssl_val[0]?.percentage_or_value}
                                                                    text='Enter Service Percentage' type='number' />
                                                                </div>
                                                                <div style={{ flex: 1 }} className='mx-2'>
                                                                    <TextValidator 
                                                                    ...
                                                                    size="small"
                                                                    // value={roundDecimal(((Number(this.state.filterData?.invoice_amount) + Number((this.state.filterData?.invoice_amount * this.state.service_val[0]?.percentage_or_value)/100) ) * this.state.ssl_val[0]?.percentage_or_value)/100, 2)} 
                                                                    value={roundDecimal((this.state.filterData?.invoice_amount * this.state.ssl_val[0]?.percentage_or_value)/100, 4)} 
                                                                    text='Enter Service Amount' 
                                                                    variant="outlined"
                                                                    disabled
                                                                    type='number' />
                                                                    <p className='hidden'>{total_value = total_value + ((this.state.filterData?.invoice_amount * this.state.ssl_val[0]?.percentage_or_value)/100) }</p>
                                                                </div>
...

                                                        {
                                                            this.state.transaction.map((item, index) => {
                                                                ...
                                                                if (item.is_percentage) {
                                                                    ...
                                                                    return (
                                                                        <Grid key={index} container spacing={2} className=" w-full">
                                                                    ...
                                                                    return (
                                                                        <Grid key={index} container spacing={2}>
                                                                            ...
                                                                            /> */}
                                                                                        <TextValidator
                                                                                            size="small"
                                                                                            // value={item.percentage_or_value}
                                                                                            value='0'
                                                        ...
                                                        >
                                                            <div style={{ display: "flex", flexDirection: "row", alignItems: "center", height: "40px" }}>
                                                                ...
                                                                <div style={{ flex: 1 }}>
                                                                    <SubTitle title={this.state.additional_val[0]?.transaction_type} />
                                                                </div>
                                                                ...
                                                                <div style={{ flex: 1 }} className='mx-2'>
                                                                    <TextValidator
                                                                        onChange={(e) => {
                                                                            ...
                                                                            let additional_val = this.state.additional_val
                                                                            additional_val[0].value = e.target.value
                                                                        ...
                                                                        size="small"
                                                                        value={roundDecimal(this.state.additional_val[0]?.value, 4)}
                                                                        text="Enter Service Amount"
                                                                        variant="outlined"
                                                                        type="number"
                                                                    // disabled = {true}
                                                                    // className=" w-full"
                                                                    />
                                                                    <p className='hidden'>{total_value = total_value + Number(this.state.additional_val[0]?.value)}</p>     {/*((this.state.filterData?.invoice_amount * this.state.service_val[0]?.percentage_or_value)/100)*/}
                                                                </div>
