...
import AllDebitNoteDetailsView from './AllDebitNoteDetailsView'
...
class AllDebitNotes extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    loadData = async () => {
        ...
        const formData = { ...this.state.formData, type: "SPC IM Debit Note" }
            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <div className="w-full h-full px-4 pb-5">
                        <PendingDebitNoteDetailsView
                            editAccess={false}
                            sequence={this.state.sequence} selected_data={this.state.selected_id} storeData={this.handleDataStore} handleReject={() => this.setState({ rejectOpen: true })} handleClose={() => this.setState({ viewDet: false })} submitOpen={() => this.setState({ forwardOpen: true })} />
                    </div>
                </Dialog>
                <Dialog
                    fullWidth={true}
...
export default withStyles(styleSheet)(AllDebitNotes)
