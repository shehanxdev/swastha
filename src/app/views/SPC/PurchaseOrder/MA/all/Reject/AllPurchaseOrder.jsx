    ...
    useEffect(() => {
        if (pageData) {
            ...
            const param = {
                ...
                page: pageData.page,
                // status: 'Draft',
                status: ['REJECTED', 'SUPERVISOR REJECTED'],
    ...
    const tableColumns = [
        {
            ...
            options: {
                customBodyRenderLite: (dataIndex) => {
                    ...
                    return (
                        <Grid className="px-2">
                            <Tooltip title={userRoles.includes('SPC MA') ? "Re-Submit" : "View"}>
                                <IconButton onClick={() => pageHandler(tempTableData)}>
                                    {userRoles.includes("SPC MA") ? <PublishIcon color="primary" /> : <VisibilityIcon color="primary" />}
                                </IconButton>
                            </Tooltip>
                        </Grid>
                    )
