...
const Row = (props) => {
    ...
    >
        ...
        <div className={classes.medMax}><HoverableText text={drug.type} /></div>
        <div className={classes.medMax}><HoverableText text={drug.noOfPosition} /></div>
        <div className={classes.medMax}><HoverableText text={drug.designation} /></div>
        <div className={classes.medMax}><HoverableText text={`${drug.duration} Months`} /></div>
