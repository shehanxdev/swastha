...
import { CircularProgress, Divider, Grid, Icon, IconButton, InputAdornment, Tooltip, Typography,  Dialog,DialogActions,DialogContent,TextField, Fab,} from "@material-ui/core";
...
class SingleNMRARequest extends Component {
    constructor(props) {
        super(props)
    ...
    async LoadData() {
        ...
        filterData.status = ['NMRA Approved', 'Circular Generated']
     ...
     async LoadQualityIncident(id){
        ...
        if (res.status == 200) {
            ...
            this.setState({
                ...
                this.getManufactures(id)
                console.log("qaIncidents",this.state.formData)
            }
             )
    ...
    async getManufactures (id){
    

        let params = {
            search_type : 'MANUFACTURE',
            nmqal_recommandation_id : id
        }
...
export default withStyles(styleSheet)(SingleNMRARequest)
