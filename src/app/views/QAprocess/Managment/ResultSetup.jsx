...
class ResultSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
        ...
        let res
            ...
            if (this.state.isUpdate) {
                ...
                if (200 == res.status) {
                    ...
                    this.setState({
                        alert: true,
                        message: 'Result Updated Unsuccessful',
                        severity: 'error',
                    })
                }
                ...
                if (201 == res.status) {
                    ...
                    this.setState({
                        alert: true,
                        message: 'Result Registration Unsuccessful',
                        severity: 'error',
                    })
                }
            }
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Result Management" />
...
export default withStyles(styleSheet)(ResultSetup)
