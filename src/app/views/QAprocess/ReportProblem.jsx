...
class ReportProblem extends Component {
            ...
            columns1: [
                ...
                // }, 
                {
                    ...
                    options: {
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            let data =
                                this.state.data[dataIndex]?.batch_no
                            return <p>{data}</p>
                        },
                    },
                },
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            let data =
                                this.state.data[dataIndex]?.Manufacturer?.name
                            return <p>{data}</p>
                        },
                    },
                },
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            let data =
                                this.state.data[dataIndex]?.pack_size
                            return <p>{data}</p>
                        },
                    },
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRenderLite: (dataIndex) => {
                            let data =
                                this.state.data[dataIndex]?.unit_price
                            return <p>{data}</p>
                        },
                    },
                },
                {
                    name: 'total_qty',
                    label: 'Total Quantity at Institute',
                    options: {
                        display: true,
                        customBodyRenderLite: (dataIndex) => {
                                        ...
                                        <Tooltip title="Allocate">
                                            <IconButton
                                                onClick={() => {
                                                    ...
                                                    formData.medium_description = this.state.data[tableMeta.rowIndex]?.ItemSnap?.medium_description
                                                    formData.batch_no = this.state.data[tableMeta.rowIndex].batch_no
    ...
    async loadTotalQTY() {
        ...
        // }
        for (let index = 0; index < this.state.data.length; index++) {
            let item_batch_id = this.state.data[index]?.id;
    ...
    async loadItemData(item_batch_id) {
        ...
        if (batch_res.status == 200) {
            ...
            console.log('itembatchdata', this.state.data)
        }
    }
    async setPage(page) {
    ...
    async loadData() {
        ...
        let params = {
            ...
            limit: 20,
            batch_no: formData.item_batch_id,
            exp_date_grater_than_zero: true
        }
        let batch_res = await InventoryService.fetchItemBatchByItem_Id(params)
        console.log('batchres2', batch_res)
        if (batch_res.status == 200) {
    ...
    selectedRows(rowData, boolean) {
        ...
        let selectedBatch = []
        let selectedArray = this.state.data.filter((data) => data.selected === 'Selected')[0].id
                                ...
                                >
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item xs={12} sm={12} md={4} lg={4} >
                                            ...
                                            <SubTitle title="Supporting Documents" className='mb-2' />
