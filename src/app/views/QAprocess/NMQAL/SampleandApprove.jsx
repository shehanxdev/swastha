...
import SampleApprove from '../NMQAL/SampleApprove'
import WarehouseServices from "app/services/WarehouseServices";
import localStorageService from "app/services/localStorageService";
import QACurrentRequests from '../NMQAL/QACurrentRequests'
const styleSheet = (theme) => ({})

class SampleandApprove extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeTab: 0,
                        ...
                        <AppBar position="static" color="default" className="mb-4 mt-2">
                            <Grid item lg={12} md={12} xs={12}>
                                <Tabs style={{ minHeight: 39, height: 26 }}
                                    ...
                                    <Tab label={<span className="font-bold text-12">Sample Received</span>} />
                                    <Tab label={<span className="font-bold text-12">Requests</span>} />
                                </Tabs>
                            </Grid>
                        </AppBar>
...
export default withStyles(styleSheet)(SampleandApprove)
