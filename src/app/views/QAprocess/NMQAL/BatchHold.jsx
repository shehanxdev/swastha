...
class BatchHold extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loaded : false,
            ...
            <Fragment>
                ...
                <MainContainer>
                        ...
                        >
                            ...
                            >
                                <Grid
                                    ...
                                    xs={12}
                                >
                                    <Typography variant='h5'>Batch Hold Requests</Typography>
                                </Grid>
                                <Grid
                                    item
                                    xs={12}
                    ...
                    <Dialog maxWidth="md"   style={{minWidth : '600px'}} open={this.state.open} onClose={this.handleClose} aria-describedby="alert-dialog-slide-description">
                        <DialogTitle>Batch Hold Request</DialogTitle>
                        <Divider/>
                        <ValidatorForm
                            className="pt-2"
                                    ...
                                    <SubTitle title="Institute"/>
                                        ...
                                        disableClearable
                                            ...
                                            renderInput={(
                                                ...
                                                <TextValidator
                                                    {...params}
                                                    placeholder="Type 3 letters or more"
                                                    //variant="outlined"
                                                    value={this.state.all_hospitals.find((v) => v.id == this.state.formData.institute_id
                                                        )}
                                                    onChange={(e) => {
...
export default withStyles(styleSheet)(BatchHold);