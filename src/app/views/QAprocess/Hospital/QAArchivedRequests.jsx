...
import QALogwise from './QALogwise'
                        ...
                        <AppBar position="static" color="default" className="mb-4 mt-2">
                            <Grid item lg={12} md={12} xs={12}>
                                <Tabs style={{ minHeight: 39, height: 26 }}
                                    ...
                                    {/* <Tab label={<span className="font-bold text-12">Graphical Representation</span>} /> */}
                                    <Tab label={<span className="font-bold text-12">Logwise</span>} />
                                </Tabs>
                            </Grid>
                        </AppBar>
...
export default withStyles(styleSheet)(QAArchivedRequests)
