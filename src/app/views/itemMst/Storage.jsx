...
class Storage extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            let res = await ItemMasterSerive.updateStorage(id, storageDTO)
            if (200 == res.status) {
                this.setState({
                    alert: true,
                ...
                this.setState({
                    alert: true,
                    message: 'Storage Updated Unsuccessful',
                    severity: 'error',
                })
            }
        }else{
        ...
        //save function
        let res = await ItemMasterSerive.createStorage(storageDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Storage Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'Storage Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllStorages(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Storage Management" />
...
export default withStyles(styleSheet)(Storage)
