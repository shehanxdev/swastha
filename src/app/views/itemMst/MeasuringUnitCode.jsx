...
class MeasuringUnitCode extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await InventoryService.updateMeasuringUnitCode(this.state.id, formData)

            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Measuring Unit Code Successfully Updated ',
                    severity: 'success',
                ...
                this.setState({
                    alert: true,
                    message: 'Measuring Unit Code Updated Unsuccessful',
                    severity: 'error',
                })
            }
            ...
            //save function
            res = await InventoryService.createMeasuringUnitCode(formData)
            ...
            if (201 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Measuring Unit Code Successfully Stored',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Measuring Unit Code Registration Unsuccessful',
                    severity: 'error',
                })
            }
        }
    ...
    async fetchDataSet() {
        ...
        const res = await InventoryService.fetchAllMeasuringUnitCode(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Item Measuring Unit Code Management" />
...
export default withStyles(styleSheet)(MeasuringUnitCode)
