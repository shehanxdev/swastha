...
class Institution extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await ItemMasterSerive.updateInstitution(id, institutionDTO)
            if (200 == res.status) {
                this.setState({
                    alert: true,
                ...
                this.setState({
                    alert: true,
                    message: 'Institution Updated Unsuccessful',
                    severity: 'error',
                })
            }
        }else{
        ...
        //save function
        res = await ItemMasterSerive.createInstitution(institutionDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Institution Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'Institution Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllInstitution(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Institution Management" />
...
export default withStyles(styleSheet)(Institution)
