...
class MovementType extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await ItemMasterSerive.updateMovementType(id, movementTypeDTO)
        console.log('Res===========>', res)
        if (200 == res.status) {
            this.setState({
                alert: true,
            ...
            this.setState({
                alert: true,
                message: 'Movement Type Updated Unsuccessful',
                severity: 'error',
            })
        }
        }else{
        ...
        //save function
        res = await ItemMasterSerive.createMovementType(movementTypeDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Movement Type Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'Movement Type Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllMovementTypes(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Movement Type Management" />
                            ...
                            >
                                <Grid item xs={12} sm={12} md={12} lg={12}>
                                    <Grid container spacing={2}>
                                        ...
                                        >
                                            <SubTitle
                                                title={'Create New Movement Type'}
                                            />
...
export default withStyles(styleSheet)(MovementType)
