...
class Stock extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await ItemMasterSerive.updateStock(id, stockDTO)
            ...
            if (200 == res.status) {
                ...
                this.setState({
                    alert: true,
                    message: 'Stock Updated Unsuccessful',
                    severity: 'error',
                })
            }
        ...
        //save function
        res = await ItemMasterSerive.createStock(stockDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Stock Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'Stock Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllStocks(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Stock Management" />
...
export default withStyles(styleSheet)(Stock)
