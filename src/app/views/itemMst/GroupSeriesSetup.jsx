...
class GroupSeriesSetup extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
        ...
        return (
            <Fragment>
                <MainContainer>
                    {/* Filtr Section */}
                    <LoonsCard>
                        <CardTitle title="Group Series Setup" />
                                ...
                                <Grid item xs={12} sm={12} md={12} lg={12}>
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid
                                            ...
                                            lg={12}
                                        >
                                            <SubTitle title="Item Category Series Definition" />
                                        ...
                                        >
                                            <Grid container spacing={2}>
                                                ...
                                                <Grid
                                                    ...
                                                    xs={12}
                                                >
                                                    <SubTitle title="Series Start Number" />

                                                    <TextValidator
                                                        className=" w-full"
                                                        placeholder="Series Start Number"
                                                        name="phn"
                                                        InputLabelProps={{
                                                            shrink: false,
                                                        }}
                                                ...
                                                <Grid
                                                    ...
                                                    xs={12}
                                                >
                                                    <SubTitle title="Series End Number" />

                                                    <TextValidator
                                                        className=" w-full"
                                                        placeholder="Series End Number"
                                                        name="phn"
                                                        InputLabelProps={{
                                                            shrink: false,
                                                        }}
                                                ...
                                                <Grid
                                                    ...
                                                    xs={12}
                                                >
                                                    <SubTitle title="Item Group Name" />
...
export default withStyles(styleSheet)(GroupSeriesSetup)
