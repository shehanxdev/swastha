...
class DefaultFrequency extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await InventoryService.updateDefaultFrequency(
                this.state.id,
                formData
            )
            ...
            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Default Frequency Successfully Updated',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Default Frequency Updated Unsuccessful',
                    severity: 'error',
                })
            }
        } else {
            //save function
            res = await InventoryService.createDefaultFrequency(formData)
            ...
            if (201 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Default Frequency Successfully Stored',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Default Frequency Registration Unsuccessful',
                    severity: 'error',
                })
            }
        }
    ...
    async fetchDataSet() {
        ...
        const res = await InventoryService.fetchAllDefaultFrequency(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Item Default Frequency Management" />
                ...
                >
                    <div className="w-full h-full px-5 py-5">
                        ...
                        <div>
                            <p>
                                This Batch will be deleted and you will have to
                                apply for a new batch. This cannot be undone.
                            </p>
                            <Grid
                                container="container"
                                style={{
...
export default withStyles(styleSheet)(DefaultFrequency)
