...
class DefaultRoutes extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await InventoryService.updateDefaultRoute(this.state.id, formData)
            ...
            //save function
            res = await InventoryService.createDefaultRoute(formData)
    ...
    async fetchDataSet() {
        ...
        const res = await InventoryService.fetchAllDefaultRoute(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Item Default Route Management" />
...
export default withStyles(styleSheet)(DefaultRoutes)
