...
class UOM extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            let res = await ItemMasterSerive.updateUOM(id, UOMDTO)
            if (200 == res.status) {
                this.setState({
                    alert: true,
                ...
                this.setState({
                    alert: true,
                    message: 'UOM Updated Unsuccessful',
                    severity: 'error',
                })
            }
        }else{
        //save function
        let res = await ItemMasterSerive.createUOM(UOMDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'UOM Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'UOM Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllUOMs(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="UOM Management" />
...
export default withStyles(styleSheet)(UOM)
