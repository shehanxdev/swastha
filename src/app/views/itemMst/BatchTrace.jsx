...
class BatchTrace extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await ItemMasterSerive.updateBatchTrace(this.state.id, formData)

            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Batch Trace Successfully Updated',
                    severity: 'success',
                ...
                this.setState({
                    alert: true,
                    message: 'Batch Trace Updated Unsuccessful',
                    severity: 'error',
                })
            }
            ...
            //save function
            res = await ItemMasterSerive.createBatchTrace(formData)
            ...
            if (201 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Batch Trace Successfully Stored',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Batch Trace Registration Unsuccessful',
                    severity: 'error',
                })
            }
        }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllBatchTrace(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Batch Trace Management" />
...
export default withStyles(styleSheet)(BatchTrace)
