...
class DosageForm extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeStep: 1,
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await InventoryService.updateDosageForm(this.state.id, formData)
            ...
            if (200 == res.status) {
                ...
                this.setState({
                    alert: true,
                    message: 'Dosage Form Updated Unsuccessful',
                    severity: 'error',
                })
            }
            ...
            //save function
            res = await InventoryService.createDosageForm(formData)
            ...
            if (201 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Dosage Form Successfully Stored',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Dosage Form Registration Unsuccessful',
                    severity: 'error',
                })
            }
        }
    ...
    async fetchDataSet() {
        ...
        const res = await InventoryService.fetchAllDosageForm(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Item Dosage Form Management" />
...
export default withStyles(styleSheet)(DosageForm)
