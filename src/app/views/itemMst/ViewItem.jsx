...
class ViewItem extends Component {
    ...
    //     if (res.status == 200 && res.data.view != null) {
    //         console.log("item Data", res.data.view)
    
    //         if (res.data.view.ItemUOM != null) {
                ...
                overrides: {
                  MuiFormControlLabel: {
                    label: {
                      ...
                      '&$disabled': {
                        color: 'black', // Change the label color to black when disabled
                      },
                    },
                  },
                  MuiRadio: {
                    colorSecondary: {
                      '&$disabled': {
                        color: 'black', // Change the radio color to black when disabled
                      },
                    },
                  },
                },
   ...
   {this.state.loaded?                      
                  <ValidatorForm
                            ...
                            onError={() => null}
                        >
                            <LoonsCard className="mt-5 mb-5 pt-5 pb-5">
                                ...
                                <Grid className='mt-2' container spacing={2}>
                                            ...
                                            {/* <Grid className=" w-full" item lg={4} md={4} sm={12} xs={12} >
                                                ...
                                                <Autocomplete
                                                  disableClearable
                                                    ...
                                                    // }}
                                                    disabled={true}
                                                    // value={this.state.formData.uoms.map((e)=> e.name)}            
                                                    multiple
                                                    getOptionLabel={(option) => option.name}
                                                    renderInput={(params) => (
                                                        <TextValidator
                                    ...
                                    <Grid item xs={3} sm={2} md={3} lg={3}>
                                        {/* <div> */}
                                            ...
                                            <Typography variant="h5" className="mt-3 font-semibold">{this.state.formData.sr_no}</Typography>
                                        {/* </div> */}
                                    </Grid>
                                </Grid>
