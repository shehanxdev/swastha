...
class DisplayUnits extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await InventoryService.updateDisplayUnit(this.state.id, formData)

            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Display Unit Successfully Updated',
                    severity: 'success',
                ...
                this.setState({
                    alert: true,
                    message: 'Display Unit Updated Unsuccessful',
                    severity: 'error',
                })
            }
            ...
            //save function
            res = await InventoryService.createDisplayUnit(formData)
            ...
            if (201 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Display Unit Successfully Stored',
                    severity: 'success',
                })
                this.fetchDataSet()
            } else {
                this.setState({
                    alert: true,
                    message: 'Display Unit Registration Unsuccessful',
                    severity: 'error',
                })
            }
        }
    ...
    async fetchDataSet() {
        ...
        const res = await InventoryService.fetchAllDisplayUnit(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Item Display Unit Management" />
...
export default withStyles(styleSheet)(DisplayUnits)
