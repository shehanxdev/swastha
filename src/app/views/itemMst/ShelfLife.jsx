...
class ShelfLife extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            res = await ItemMasterSerive.updateShelfLife(id, shelfLifeDTO)
        
            if (200 == res.status) {
                this.setState({
                    alert: true,
                    message: 'Shelf Life Successfully Updated',
                    severity: 'success',
                })
            } else {
                this.setState({
                    alert: true,
                    message: 'Shelf Life Updated Unsuccessful',
                    severity: 'error',
                })
            }
        }else{
        ...
        //save function
        res = await ItemMasterSerive.createShelfLife(shelfLifeDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Shelf Life Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'Shelf Life Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllShelfLife(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Shelf Life Management" />
...
export default withStyles(styleSheet)(ShelfLife)
