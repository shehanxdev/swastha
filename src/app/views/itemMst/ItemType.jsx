...
class ItemType extends Component {
    ...
    handleDataSubmit = async () => {
        ...
        if (this.state.isUpdate) {
            let res = await ItemMasterSerive.updateItemType(id, itemTypeDTO)    
            if (200 == res.status) {
                this.setState({
                    alert: true,
                ...
                this.setState({
                    alert: true,
                    message: 'Item Type Updated Unsuccessful',
                    severity: 'error',
                })
            }
        }else{
        ...
        //save function
        let res = await ItemMasterSerive.createItemType(itemTypeDTO)
        ...
        if (201 == res.status) {
            this.setState({
                alert: true,
                message: 'Item Type Successfully Stored',
                severity: 'success',
            })
        } else {
            this.setState({
                alert: true,
                message: 'Item Type Stored Unsuccessful',
                severity: 'error',
            })
        }
    }
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllItemTypes(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Item Type Management" />
...
export default withStyles(styleSheet)(ItemType)
