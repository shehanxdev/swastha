...
if (this.state.isUpdate) {
    res = await ItemMasterSerive.updateCondition(id, conditionDTO)
    if (200 == res.status) {
        this.setState({
            alert: true,
        ...
        this.setState({
            alert: true,
            message: 'Condition Updated Unsuccessful',
            severity: 'error',
        })
    }
}else {
//save function
res = await ItemMasterSerive.createCondition(conditionDTO)
...
if (201 == res.status) {
    this.setState({
        alert: true,
        message: 'Condition Successfully Stored',
        severity: 'success',
    })
} else {
    this.setState({
        alert: true,
        message: 'Condition Stored Unsuccessful',
        severity: 'error',
    })
}
}
    ...
    async fetchDataSet() {
        ...
        const res = await ItemMasterSerive.fetchAllCondition(filterData)
    ...
    render() {
        ...
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Condition Management" />
...
export default withStyles(styleSheet)(Condition)
