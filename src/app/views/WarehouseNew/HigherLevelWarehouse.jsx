...
class HigherLevelWarehouse extends Component {
                ...
                <MainContainer>
                        ...
                        <Grid item lg={12} className=" w-full ">
                            ...
                            >
                                ...
                                >
                                    <span className="capitalize">Add Wherehouses</span>
                                </Button>
                            </Grid>
                              ...
                              <Grid
                                    ...
                                    <Grid item="item" lg={11} md={9} xs={9}>
                                        <Grid container="container" lg={12} md={12} xs={12} className='ml-4'>
                                            <CardTitle title="Add Higher Level" />
                                        </Grid>
                                    </Grid>
...
export default HigherLevelWarehouse
