...
// {this.props.status == 'Batch Withdraw'||this.props.status == 'Item Withdraw'}
    ...
    async loadDrugStoreData() {
        ...
        let owner_id = this.props.ownerID
    ...
    async loadOrderList() {
        ...
        // if(user_role.includes('Drug Store Keeper')||user_role.includes('Medical Laboratory Technologist')||user_role.includes('Radiographer')|| user_role.includes('Counter Pharmacist')||user_role.includes('RMSD OIC')
        // ||user_role.includes('RMSD MSA')||user_role.includes('RMSD Pharmacist')|| user_role.includes('Admin Pharmacist')
        // ||user_role.includes('Pharmacist')|| user_role.includes('Drug Store Officer')){
        ...
        if(this.props.status == 'Expired Drugs'){
            ...
            formData.item_main_status=['Withdraw']
            
        }
        else if(this.props.status == 'Item Withhold'){
            formData.item_main_status=['Withhold','Temporary Withhold'] 
        }
