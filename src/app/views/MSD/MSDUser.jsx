...
class MSDUser extends Component {
    constructor(props) {
        super(props)
        this.state = {
            processing: false,
            ...
            filterData: {
                ...
                type: appConst.msd_user_type.map(a => a.type)
            },
    ...
    async saveVehicleUser() {
        ...
        if (res1.status == 201) {
            if (formData.type == 'Driver' || formData.type == 'Helper'|| formData.type == 'HSCO'|| formData.type == 'Item Master Admin'|| 
            formData.type == 'MSD AD'|| formData.type == 'MSD CIU'|| formData.type == 'MSD Director'|| 
            formData.type == 'MSD Distribution Officer'|| formData.type == 'MSD Security'|| formData.type == 'MSD SCO'|| formData.type == 'MSD SDA') {
    ...
    async getLoginedHospital() {
        ...
        this.setState({ formData, empFormData, filterData }, () => {
            this.loadData();
                            ...
                            <Grid container spacing={1} className="flex ">
                                ...
                                >
                                    ...
                                    <Autocomplete
                                        ...
                                        // value={appConst.msd_user_type.find(
                                        //     (v) =>
                                        //         v.type ===
                                        //         this.state.formData
                                        //             .type
...
export default withStyles(styleSheet)(MSDUser)
