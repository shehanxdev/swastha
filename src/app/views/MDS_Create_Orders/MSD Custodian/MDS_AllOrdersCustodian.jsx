...
class MDS_AllOdersCustodian extends Component {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            if (tableMeta.rowData[tableMeta.columnIndex] == null) {
                                ...
                                return (tableMeta.rowData[tableMeta.columnIndex].time_from)
                            }
                        }
                    }
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            if (tableMeta.rowData[tableMeta.columnIndex] == null) {
                                ...
                                return (tableMeta.rowData[tableMeta.columnIndex].time_to)
                            }
                        }
                    }
    ...
    viewIndividualOrder(id) {
        window.location = `/MDS/custodianprofile/all-items/${id}`;
    }
    ...
    componentDidMount() {
        let filterData = this.state.filterData
        filterData.pickup_person_id = this.props.id
        this.setState({
            filterData
        })
        this.preLoadData();
...
export default MDS_AllOdersCustodian