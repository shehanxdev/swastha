...
class SetItemEstimations extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    value={this.state.data[tableMeta.rowIndex]?.jan}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].jan = e.target.value

                                        data[tableMeta.rowIndex].real_estimation = parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].feb)+parseInt(this.state.data[tableMeta.rowIndex].mar)+
                                        parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)

                                        data[tableMeta.rowIndex].estimation = parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].feb)+parseInt(this.state.data[tableMeta.rowIndex].mar)+
                                        parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)


                                        console.log('num', data[tableMeta.rowIndex].real_estimation)
                                        console.log('num', data[tableMeta.rowIndex].feb)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.feb}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                       data[tableMeta.rowIndex].feb = e.target.value
                                       
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].mar)+
                                        parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                                        
                                        data[tableMeta.rowIndex].estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].mar)+
                                        parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.mar}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].mar = e.target.value

                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+parseInt(e.target.value)+
                                        parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                                        
                                        data[tableMeta.rowIndex].estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+parseInt(e.target.value)+
                                        parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.apr}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].apr = e.target.value
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)

                                        data[tableMeta.rowIndex].estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.may}
                                    type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].may = e.target.value
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.june}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].june = e.target.value
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].apr)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].july)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.july}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].july = e.target.value

                                        //total calculation
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)+parseInt(e.target.value)
                                        +parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.aug}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].aug = e.target.value

                                        //total calculation
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)
                                        +parseInt(this.state.data[tableMeta.rowIndex].july)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].sep)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.sep}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].sep = e.target.value

                                                                                //total calculation
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)
                                        +parseInt(this.state.data[tableMeta.rowIndex].july)+parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)
                                        +parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.oct}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].oct = e.target.value

                                         //total calculation
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)
                                        +parseInt(this.state.data[tableMeta.rowIndex].july)+parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)
                                        +parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].nov)+parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.nov}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].nov = e.target.value

                                                                                 //total calculation
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)
                                        +parseInt(this.state.data[tableMeta.rowIndex].july)+parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)
                                        +parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(e.target.value)+parseInt(this.state.data[tableMeta.rowIndex].dec)
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                <TextValidator
                                    ...
                                    name="phn"
                                    InputLabelProps={{ shrink: false }}
                                    value={this.state.data[tableMeta.rowIndex]?.dec}
                                     type="number"
                                    variant="outlined"
                                    size="small"
                                    onChange={(e) => {
                                       let data = this.state.data
                                        data[tableMeta.rowIndex].dec = e.target.value

                                                    //total calculation
                                        data[tableMeta.rowIndex].real_estimation = parseInt(this.state.data[tableMeta.rowIndex].jan)+parseInt(this.state.data[tableMeta.rowIndex].feb)+
                                        parseInt(this.state.data[tableMeta.rowIndex].mar)+parseInt(this.state.data[tableMeta.rowIndex].may)+parseInt(this.state.data[tableMeta.rowIndex].june)
                                        +parseInt(this.state.data[tableMeta.rowIndex].july)+parseInt(this.state.data[tableMeta.rowIndex].aug)+parseInt(this.state.data[tableMeta.rowIndex].sep)
                                        +parseInt(this.state.data[tableMeta.rowIndex].oct)+parseInt(this.state.data[tableMeta.rowIndex].nov)+parseInt(e.target.value)
                ...
                //                 name="phn"
                //                 InputLabelProps={{ shrink: false }}
                //                 value={this.state.data[tableMeta.rowIndex]?.estimation}
                //                  type="number"
                //                 variant="outlined"
                //                 size="small"
                //                 onChange={(e) => {
                //                    let data = this.state.data
                //                    data[tableMeta.rowIndex].estimation = e.target.value
                //                     this.setState({ data })
                //                 }}
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                                ...
                                name="phn"
                                InputLabelProps={{ shrink: false }}
                                value={this.state.data[tableMeta.rowIndex]?.real_estimation }
                                disabled={true}
                                variant="outlined"
                                size="small"
                                onChange={(e) => {
                                   let data = this.state.data
                                //    data[tableMeta.rowIndex].real_estimation =this.state.data[tableMeta.rowIndex]?.jan+this.state.data[tableMeta.rowIndex]?.feb
                                   data[tableMeta.rowIndex].real_estimation = e.target.value
                                   data[tableMeta.rowIndex].estimation = data[tableMeta.rowIndex].real_estimation
                                    this.setState({ data })
                                }}
...
export default SetItemEstimations;