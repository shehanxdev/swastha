...
class DSEstIndiviualRequest extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loaded: true, //change to false
            alert: false,
            extenstionDialog:false,
            message: '',
            severity: 'success',
            ...
            columns: [
                ...
                },
                {
                    ...
                    options: {
                        filter: true,
                        display: true,
                        //should be the remarks from the backend change when done
                        customBodyRenderLite: (dataIndex) => {
        ...
        return (
            < Fragment >
                <MainContainer>
                        ...
                        <CardTitle title= {`Annual Estimation for the Year ${this.state.year}`} />
                        <h3> Time Period: {this.state.timePeriod}</h3>
                        ...
                        <Grid>
                        <h5> Estimated Received Institute: {this.state.timePeriod}</h5><h5> Estimated Pending Institute: {this.state.timePeriod}</h5>
                        </Grid>
                        </LoonsCard>
                            </ValidatorForm>
                            : 
                ...
                <Dialog
                        fullWidth
                        maxWidth="lg"
                        open={this.state.extenstionDialog}
                        onClose={() => {
                            this.setState({ extenstionDialog: false })
                        }}>
                            ...
                            <Grid container className=''>
                                <Grid item lg={12} md={12} sm={12} xs={12}>
                                        ...
                                        <ValidatorForm
                                            ...
                                            <Grid item lg={12} md={12} sm={12} xs={12}>
                                                <h4 className='mt-5'>Estimation ID: {this.state.totalReceivedItems}</h4>
                                                <h5 className=''>Unit ID : backend </h5>
                                                <h5 className=''>Unit Name : </h5>
                                            </Grid>
                                            ...
                                            <Grid item lg={12} md={12} sm={12} xs={12}
                                                ...
                                                <h4 className=''>Extention Remarks : </h4>
                                                <TextValidator
                                                        className="w-full"
                                                        placeholder="Remarks"
                                                        name="remarks"
...
export default withStyles(styleSheet)(DSEstIndiviualRequest)
