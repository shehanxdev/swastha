...
class RMSDSetItem extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                {
                    name: 'warehouse_name', // field name in the row object
                    label: 'Warehouse Name', // column title that will be shown in table
                    options: {
                        // filter: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            // console.log("tableMeta", tableMeta);
                                let data = this.state.data[tableMeta.rowIndex]?.HosptialEstimation?.Warehouse?.name
                                return <p>{data}</p>
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            // console.log("tableMeta", tableMeta);
                                let data = this.state.data[tableMeta.rowIndex]?.HosptialEstimation?.Warehouse?.type
                                return <p>{data}</p>
    ...
    async loadData() {
     ...
     async loadItemEstimation() {
        ...
        filterData.item_id = this.props.match.params.item_id
