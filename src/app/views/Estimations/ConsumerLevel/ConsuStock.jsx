...
class ConsuStock extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loaded: true,
            ...
            columns: [
                ...
                {
                    name: 'stock_days', // field name in the row object
                ...
                {
                    name: 'quanity', // field name in the row object
    ...
    render() {
        return (
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        <CardTitle title="Stock with Expiry Datesaa" />
                                ...
                                <Grid container spacing={1} className="flex">
                                    ...
                                    <Grid className=" w-full" item lg={6} md={6} sm={12} xs={12} >
                                        ...
                                        disableClearable
                                                    ...
                                                    value={this.state.formData.measuringUnit}
                                                    ...
                                                    renderInput={(params) => (
                                                        <TextValidator
                                                            ...
                                                            variant="outlined"
                                                            size="small"
                                                            value={this.state.allMeasuringUnit}
                                                            validators={[
                                                                'required',
                                                            ]}
                                                            errorMessages={[
