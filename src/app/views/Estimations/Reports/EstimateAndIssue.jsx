    ...
    async dataLoad() {
        ...
        if (includesArrayElements(userRoles, ['Devisional Pharmacist', 'RDHS']) && this.props.dpView) {
            params = {
                ...
                provincial: this.props.estimationData.institute_category == "Provincial" ? true : false,
        ...
        if (resp.status === 200 && res.status === 200) {
            ...
            updatedArray = resp.data.view.map((obj1) => {
                ...
                obj1.msd_issuance = obj2?.quantity
                //obj1.fr = obj2?.fr
                    ...
                    <table className="w-full" border="1" cellpadding="1" cellspacing="1" style={{ borderColor: 'white' }} >
                        <thead>
                            <tr style={{ width: '100%' }}>
                                ...
                                <td style={{ width: '15%', textAlign: 'center', backgroundColor: '#9C27B0', fontWeight: 600 }}>Annual Estimate</td>
                                {/* <td style={{ width: '15%', textAlign: 'center', backgroundColor: '#9C27B0', fontWeight: 600 }}>F.R</td> */}
                                <td style={{ width: '15%', textAlign: 'center', backgroundColor: '#9C27B0', fontWeight: 600 }}>Issued QTY</td>
                                <td style={{ width: '40%', textAlign: 'center', backgroundColor: '#9C27B0', fontWeight: 600 }}>Issued / Estimate</td>
                            </tr>
                        </thead>
                        <tbody>
