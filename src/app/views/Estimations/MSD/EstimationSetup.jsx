                    ...
                    options: {
                        customBodyRenderLite: (dataIndex) => {
                            return <Grid className="flex ">
                                ...
                                <Tooltip title="Create Estimation">
                                    <IconButton
                                        onClick={() => {
                                            ...
                                            window.location.href = `/estimation/estimation_create/${this.state.data[dataIndex].id}?year=${this.state.data[dataIndex].year}`
                                ...
                                <Tooltip title="Edit">
                                    <IconButton
                                        onClick={() => {
                                            ...
                                            formData.year = this.state.data[dataIndex].year
                                ...
                                <Tooltip title="View Submited Estimations">
                                    <IconButton
                                        onClick={() => {
                                            window.location.href = `/estimation/totalEstimationWarehouseWise/${this.state.data[dataIndex].id}`
