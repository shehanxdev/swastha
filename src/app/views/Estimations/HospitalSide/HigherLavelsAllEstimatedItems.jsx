...
import HospitalItemsList from './ApprovalsView/HospitalItemsList'
...
class HigherLavelsAllEstimatedItems extends Component {
    constructor(props) {
        super(props)
        this.state = {
...
export default withStyles(styleSheet)(HigherLavelsAllEstimatedItems)