...
class ToBeAllocated extends Component {
    constructor(props) {
        super(props)
        this.state = {
            ...
            filterData: {
                ...
                status: ['APPROVED', 'Pending', 'ORDER', 'Pending Approval'],
                date_type: null,
                from_date: null,
                to_date: null,
                from: null,
    ...
    //     console.log('checking filter data', this.state.filterData)

    //     let filterData = this.state.filterData;

    //     if ((filterData.date_type) && (filterData.from_date) && (filterData.to_date) && (filterData.from_owner_id) ||
    //         !(filterData.date_type) && !(filterData.from_date) && !(filterData.to_date) && !(filterData.from_owner_id)) {
    //         //  alert("Sent the Request");
    //         this.loadOrderList()
    //     }
    //     else {
    ...
    async loadOrderList() {
        ...
        console.log('cheking type', user.roles[0])
        ...
        if (res.status) {
            ...
            this.setState({
               ...
               Loaded: true,
                to_be_allocated: res.data.view.totalItems,
                ...
                <ValidatorForm
                    ...
                    <Grid container>
                        <Grid lg={12} md={12} sm={12} xs={12} style={{ textAlign: 'end' }} className='pr-5'>
                            <h3>No of orders to be allocated : {this.state.to_be_allocated}</h3>
                        </Grid>
                            ...
                            <DatePicker
                                ...
                                onChange={(date) => {
                                    ...
                                    if (date) {
                                        ...
                                        console.log("date value",filterData.from_date)
...
export default withStyles(styleSheet)(ToBeAllocated)