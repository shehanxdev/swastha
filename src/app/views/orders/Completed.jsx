            ...
            columns: [
                ...
                }, */
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return this.state.data[tableMeta.rowIndex].createdAt
                                ? dateParse(
                ...
                },
                {
                    ...
                    options: {
                        display: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return this.state.data[tableMeta.rowIndex].toStore
                                .name
                        },
                    },
                },
            ...
            this.setState(
                {
                    ...
                    Loaded: true,
                    completed: res.data.view.totalItems,
                ...
                >
                    <Grid container className="">
                        <Grid
                            ...
                            className="pr-5"
                        >
                            <h3>No of Completed : {this.state.completed}</h3>
                        </Grid>
...
export default withStyles(styleSheet)(Completed)
