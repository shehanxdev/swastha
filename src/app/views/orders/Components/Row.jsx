...
class Row extends Component {
    ...
    exceedFunction() {
        ...
        this.setState({
            alert: true,
            message: "Store Quantity Exceeded. Please enter a lower value. Maxumim stock of " + document.getElementById(this.props.row.warehouse_id).value + " will be added.",
            severity: "Error"
        })
                ...
                <TableRow>
                    <td>
                        ...
                        <IconButton onClick={() => {
                            ...
                            onClickView &&
                                onClickView({
                                    warehouse_id:this.props.row.warehouse_id
                                });
