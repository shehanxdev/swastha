...
import ItemsBatchView from '../ItemsBatchView';
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            if (tableMeta.rowData[8] == null) {
                                ...
                                return roundDecimal(tableMeta.rowData[8], 1)
                            }
                        }
                    }
                },
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            if (tableMeta.rowData[10] == null) {
                                ...
                                return Math.floor(tableMeta.rowData[10])
                            }
                        }
                    }
                }, {
                                    ...
                                    <Tooltip
                                        ...
                                        <IconButton
                                            ...
                                            onClick={() => {
                                                ...
                                                medDetails.itemName = tableMeta.rowData[1]
                                                medDetails.drugStore = tableMeta.rowData[3]
                                    ...
                                    <Tooltip title="View Batches">
                                        <IconButton
                                            ...
                                            onClick={() => {
                                                this.setState({
                                                    selected_item_id: this.state.data[tableMeta.rowIndex].item_id,
                                                    item_warehouse_id: this.state.data[tableMeta.rowIndex].OrderRequirement.warehouse_id,
                                                    showItemBatch: true
                                                })
                                            }}
                                        >
                            ...
                            ? this
                                ...
                                .map((row) => (
                                    <Row
                                        ...
                                        onClickView={(data) => {
                                            this.setState({
                                                item_warehouse_id: data.warehouse_id,
                                                showItemBatch: true
                                            })
                                        }}
                                        onChangeFunc={this
                    ...
                    <div
                        ...
                        <ValidatorForm
                            ...
                            <Grid
                                ...
                                <Grid item="item" lg={3} md={3} xs={12}>
                                    <h5 >Set Order For</h5>
                                </Grid>
                                <Grid item="item" lg={2} md={2} xs={12} className="mr-2">
                                    <Autocomplete
                                        disableClearable
                            ...
                            <Grid container="container" spacing={2}>
                                    ...
                                    <TextValidator
                                        ...
                                        onChange={(e) => {
                                            this.setState({
                                                formData: {
                                                    ...this.state.formData,
                                                    moreStock: parseInt(e.target.value)
                                                }
                                            })
                                        }} />
                                </Grid>
                                    ...
                                    <TextValidator
                                        ...
                                        onChange={(e) => {
                                            this.setState({
                                                formData: {
                                                    ...this.state.formData,
                                                    lessStock: parseInt(e.target.value)
                                                }
                                            })
                                        }}
                                ...
                                <Grid className=" w-full" item="item" lg={3} md={3} sm={12} xs={12}>
                                    ...
                                    <TextValidator className=" w-full" placeholder="Drug Store Qty" name="drug_store_qty" InputLabelProps={{
                                        shrink: false
                                    }} value={this.state.formData.drug_store_qty} type="text" variant="outlined" size="small" onChange={(e) => {
                                        this.setState({
                                            formData: {
                                                ...this.state.formData,
                                                drug_store_qty: e.target.value
                                            }
                                        })
                                    }}
                                        validators={['minNumber:0.99']}

                                        errorMessages={['Cannot enter more than 2 decimals']}
                                    />
                                </Grid>

                                {/* Drug Store Qty*/}
                                <Grid className=" w-full" item="item" lg={3} md={3} sm={12} xs={12}>
                                    <SubTitle title="My Store Qty" />

                                    <TextValidator className=" w-full" placeholder="Drug Store Qty" name="drug_store_qty" InputLabelProps={{
                                        shrink: false
                                    }} value={this.state.formData.my_store_qty} type="text" variant="outlined" size="small" onChange={(e) => {
                                        this.setState({
                                            formData: {
                                                ...this.state.formData,
                                                my_store_qty: e.target.value
                                            }
                                        })
                                    }}
                                    //validators={['required']}
                ...
                <div className="w-full h-full px-5 py-5">
                    ...
                    <Grid container="container">
                        <Grid item="item" lg={12} md={12}>
                            <CardTitle title="Suggested Ware House"></CardTitle>
                        </Grid>
                        <Grid
                            item="item"
                            style={{
                            ...
                            <LoonsCard>
                                <Grid
                                    ...
                                    <Grid
                                        ...
                                        Total Requested Quantity : {parseFloat(this.state.orderItemDataTot.length > 0 ? this.state.orderItemDataTot[0].request_quantity : 0)}
                                    </Grid>
                                </Grid>
                                <Divider className='mb-4' />
                                <LoonsTable
