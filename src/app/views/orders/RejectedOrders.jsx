...
class RejectedOrders extends Component {
    ...
    async reorder() {
        ...
        let body = {
            ...
            type: "Order",
            distribution_officer_id:this.state.orderToReOrder.distribution_officer_id,
            // order_id: "ecb86814-4ec8-45d4-be5c-fc36f5b10c22",
            required_date: this.state.orderReqDate,
            number_of_items: this.state.orderToReOrder.number_of_items,
            order_for:this.state.orderToReOrder.order_for,
            special_normal_type:this.state.orderToReOrder.special_normal_type,
            status: "Active",
            item_list: items
                        ...
                        >
                            <TextValidator
                                ...
                                onChange={(e, value) => {
                                    let filterData = this.state.filterData
                                    if (e.target.value) {
                                        let filterDataValidation =
                                            this.state.filterDataValidation
