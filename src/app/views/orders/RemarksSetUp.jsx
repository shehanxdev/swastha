import { CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Divider, FormLabel, Grid, Icon, IconButton,DialogContentText } from "@material-ui/core";
import { Autocomplete } from "@material-ui/lab";
import { Button, CardTitle, LoonsCard, LoonsSnackbar, LoonsSwitch, LoonsTable, MainContainer, SubTitle } from "app/components/LoonsLabComponents";
...
class RemarksSetUp extends Component {
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender : (value, tableMeta, updateValue) =>{
                            //console.log('data name',this.state.data);
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender : (tableMeta) =>{
                           return(<p>{dateParse(tableMeta)}</p>)
                        }
                    }
                },
                {
                    ...
                    options: {
                        ...
                        display: true,
                        customBodyRender: (value, tableMeta, updateValue) => {
                            console.log('data',this.state.data[tableMeta.rowIndex]);
                            return (
                                <>
        ...
        if (res.status == 200) {
            this.setState({ 
                ...
                totalItems:res.data.view.totalItems,
                 ...
                 () => { console.log(this.state.data); this.render() })
            return;
        }
                    ...
                    <LoonsCard>
                        ...
                        <ValidatorForm
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item lg={3} style={{ display: 'flex', alignItems: 'flex-end' }} >
                                    <Button type='submit' >
                                        Filter
                                    </Button>
                                </Grid>
