...
class OrderTab1 extends Component {
              ...
              },
              {
                  ...
                  options: {
                      customBodyRender: (value,tableMeta, updateValue) => {
                          ...
                          return (
                            <>
                            {this.state.data[tableMeta.rowIndex]?.status !== "Forecast Rejected" && 
  ...
  async loadOrderList() {
      ...
      const statuses = { 
        "HSCO":["HSCO Approved","HSCO Rejected","Pending Approval","Distribution Officer Checked","Pending Approval"],
        "MSD AD":["AD Checked","AD Forecast Approved","AD Forecast Rejected","Accountant Approved","HSCO Checked","Distribution Officer Order Checked"],
        "MSD SDA":["Accountant Approved","Accountant Rejected","HSCO Approved"],
        "Chief Accountant":["Accountant Approved","Accountant Rejected","HSCO Approved"],
        "Distribution Officer":["Distribution Forecast Pending","HSCO Order Checked"],
        "MSD Distribution Officer":["Distribution Forecast Pending","HSCO Order Checked"]
    }

      

       let role = localStorageService.getItem("userInfo").roles[0];


      this.state.formData = { ...this.state.formData, status: statuses[`${role}`] }
