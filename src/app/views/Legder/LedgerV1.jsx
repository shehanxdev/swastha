...
class LedgerV1 extends Component {
    ...
    render() {
        ...
        // const allDates = new Set([this.state.data.map((entry) => entry.updatedAt), this.state.datamin.map((entry) => entry.updatedAt)]);
        // console.log('alldates', allDates)
        // const filteredData = this.state.data.filter((entry) => allDates.has(entry.updatedAt));
        // const filteredDataMin = this.state.datamin.filter((entry) => allDates.has(entry.updatedAt));
        // console.log('filteredData', filteredData)
        // console.log('filteredDataMin', filteredDataMin)
            ...
            <Fragment>
                <MainContainer>
                    <LoonsCard>
                        ...
                        <ValidatorForm onSubmit={() => this.dataSubmit()} onError={() => null} className="w-full p-3">
                        ...
                        {this.state.loaded ?
                            <>
                                <div className='p-4' >
                                    ...
                                    <ReactToPrint
                                        trigger={() => <LoonsButton>Print <PrintIcon className='px-1' /></LoonsButton>}
...
export default withStyles(styles)(LedgerV1)
