...
export const colorStyles = makeStyles(({ palette, ...theme }) => ({
    '@global': {
        ...
        //added by Roshan --------------------
        '.button-success': { transition: 'all 250ms', color: 'white', backgroundColor: '#28a745 !important' },
        '.button-success:hover': { background: `#1b6d2d !important` },

        '.button-danger': { transition: 'all 250ms', color: 'white', backgroundColor: '#dc3545  !important' },
        '.button-danger:hover': { background: `#ad2834 !important` },

        '.button-warning': { transition: 'all 250ms', color: 'white', backgroundColor: '#ffc107  !important' },
        '.button-warning:hover': { background: `#ce9a00 !important` },

        '.button-info': { transition: 'all 250ms', color: 'white', backgroundColor: '#17a2b8 !important' },
        '.button-info:hover': { background: `#087182 !important` },

        '.button-dark': { transition: 'all 250ms', color: 'white', backgroundColor: '#343a40 !important' },
        '.button-dark:hover': { background: `#16191b !important` },
