...
class PrescriptionSummaryPieChart extends Component {
    ...
    async loadData() {
        ...
        let params = {
            ...
            type: 'Order',
            from: warehouse.frontDesk_id, // send order id - chief pharmacist, prescription summary ok, exchanges not nessasary, drug co. warehouse id =! owner id, active prescri. okay, pending not, issued presc -> issue_id =! owner_id,
            // drug stock pharmacist - prescription and exchanges remove, order on me and by me  summary / by me okay from / on me to = warehouse_id, pending exchanges remove, pending order by me and from others ( pending exchnges add without action ) / by me = requested_to / from others = reuested_from
            // to: this.state.to,
        }
