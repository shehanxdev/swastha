...
class PrescriptionSummaryPieChart extends Component {
    ...
    async loadData() {
        ...
        let params = {
            ...
            type: 'Order',
            to: warehouse.frontDesk_id, // send order id - chief pharmacist, prescription summary ok, exchanges not nessasary, drug co. warehouse id =! owner id, active prescri. okay, pending not, issued presc -> issue_id =! owner_id,
