...
class PresentationAFI extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                                        ...
                                        >
                                            <TextValidator
                                                ...
                                                onChange={(e) => {
                                                    let formData =
                                                        this.state.formData
                                                    formData.examination_data[0].other_answers.afi =
                                                        e.target.value
...
export default withStyles(styleSheet)(PresentationAFI)
