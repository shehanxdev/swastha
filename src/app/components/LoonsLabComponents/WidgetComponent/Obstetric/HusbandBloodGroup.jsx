                ...
                examination_data: [
                    {
                        ...
                        question: 'husbands_blood_group',
                        other_answers: {
                            husbands_blood_group: null,
                            comment: null,
                        },
                    },
                ],
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Husband Blood Broup" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.husbands_blood_group
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.husbands_blood_group =
                                            'A+'
...
export default withStyles(styleSheet)(Vaccination)
