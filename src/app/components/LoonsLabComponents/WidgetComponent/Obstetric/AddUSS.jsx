...
class AddUSS extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                examination_data: [
                    {
                        ...
                        question: 'add_uss',
                        other_answers: {
                            ultra_sound_scan_date: null,
                            expected_date_of_delivery: null,
                            period_of_amenorrhea: null,
                            hc_weeks: null,
                            hc_dates: null,
                            ac_weeks: null,
                            ac_dates: null,
                    ...
                    <Grid container spacing={2}>
                            ...
                            <DatePicker
                                ...
                                value={
                                    this.state.formData.examination_data[0]
                                        .other_answers.ultra_sound_scan_date
                                }
                                onChange={(date) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.ultra_sound_scan_date =
                                        dateParse(date)
                                    this.setState({
                                        formData,
                                    })
                        ...
                        <Grid className="" item lg={6} md={6} sm={6} xs={6}>
                            ...
                            <DatePicker
                                ...
                                value={
                                    this.state.formData.examination_data[0]
                                        .other_answers.expected_date_of_delivery
                                }
                                onChange={(date) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.expected_date_of_delivery =
                                        dateParse(date)
                                    this.setState({
                                        formData,
                                    })
                        ...
                        <Grid className="" item lg={6} md={6} sm={6} xs={6}>
                            ...
                            <DatePicker
                                ...
                                value={
                                    this.state.formData.examination_data[0]
                                        .other_answers.period_of_amenorrhea
                                }
                                onChange={(date) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.period_of_amenorrhea =
                                        dateParse(date)
                                    this.setState({
                                        formData,
                                    })
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <RadioGroup>
                                <FormControlLabel
                                    label={
                                        'Get this date as EDD of the patient'
                                    }
                                    name="edd_of_patient"
                                    value="edd_of_patient"
                                    size="small"
                                    onChange={(e) => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.edd_of_patient =
                                            e.target.value
...
export default withStyles(styleSheet)(AddUSS)
