...
class OtherExamination extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                examination_data: [
                    {
                        ...
                        question: 'other_examination',
                        other_answers: {
                            thyroid_examination: 'normal',
                            breast_examination: 'normal',
                            cardio_vascular_rate: null,
                            blood_pressure: null,
                            murmur: null,
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Striae Gravidarum" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.striae_gravidarum
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.striae_gravidarum =
                                            'yes'
...
export default withStyles(styleSheet)(OtherExamination)
