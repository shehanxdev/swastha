...
class HeadEngaged extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                examination_data: [
                    {
                        ...
                        question: 'head_engaged',
                        other_answers: {
                            head_engaged: null,
                            head_engaged_type: null,
                            comment: null,
                        },
                    },
                ],
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Head Engaged" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.head_engaged
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.head_engaged =
                                            'no'
                                        this.setState({
                                            head_eng: false,
                                            formData,
                                    ...
                                    >
                                        <FormControlLabel
                                            ...
                                            onChange={() => {
                                                let formData =
                                                    this.state.formData
                                                formData.examination_data[0].other_answers.head_engaged_type =
                                                    '1/5'
...
export default withStyles(styleSheet)(HeadEngaged)
