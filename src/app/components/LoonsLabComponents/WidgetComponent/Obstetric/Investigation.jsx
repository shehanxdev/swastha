            ...
            <Fragment>
                ...
                >
                    <Grid container spacing={2} className="">
                        <Grid className="" item lg={6} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.vdrl =
                                            'negative'
                        ...
                        <Grid className="" item lg={6} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.hiv =
                                            'negative'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                        ...
                        <Grid className="" item lg={6} md={12} sm={12} xs={12}>
                            <SubTitle title="Urine Albumin" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.urine_albumin
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.urine_albumin =
                                            'negative'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                        ...
                        <Grid className="" item lg={6} md={12} sm={12} xs={12}>
                            <SubTitle title="Tetanus" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.tetanus
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.tetanus =
                                            'negative'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                        ...
                        <Grid className="" item lg={6} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.hep_b =
                                            'negative'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
