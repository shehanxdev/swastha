...
class Umbilicus extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Umbilicus" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.umbilicus
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.umbilicus =
                                            'flat'
...
export default withStyles(styleSheet)(Umbilicus)
