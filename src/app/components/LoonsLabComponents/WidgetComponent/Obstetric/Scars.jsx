                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.scars =
                                            'no'
                        ...
                        {this.state.if_scars ? (
                            <div>
                                ...
                                >
                                    ...
                                    >
                                        <FormControlLabel
                                            label={'Previous LSCS Scars'}
                                            name="previous_lscs_scars"
                                            value="previous_lscs_scars"
                                            size="small"
                                            onChange={() => {
                                                let formData =
                                                    this.state.formData
                                        ...
                                        <FormControlLabel
                                            label={
                                                'Other Surgical Scars in Abdomen'
                                            }
                                            name="other_surgical_scars_in_abdomen"
                                            value="other_surgical_scars_in_abdomen"
                                            size="small"
                                            onChange={() => {
                                                let formData =
                                                    this.state.formData
                                                formData.examination_data[0].other_answers.scars =
                                                    'other_surgical_scars_in_abdomen'
                                                this.setState({ formData })
                                            }}
                                            control={<Radio color="primary" />}
                                            display="inline"
...
export default withStyles(styleSheet)(Scars)
