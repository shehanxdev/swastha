                ...
                <ValidatorForm onSubmit={() => { this.submit() }} className='flex mx-2' >
                    <Grid container spacing={1}>  
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title='Ulcer' />
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.ulcer} row>
                                <FormControlLabel
                                    label={"No"}
                                    name="no"
                                    value="no"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.ulcer = "no"
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.ulcer = "present"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        { this.state.formData.examination_data[0].other_answers.ulcer == 'present' ?
...
export default withStyles(styleSheet)(Ulcer)
