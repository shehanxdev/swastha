...
const checkBoxData = [
    ...
    {
        label: 'Athetoid Apasms',
        value: 'athetoidApasms',
    },
    {
        label: 'Dystonic Movements',
        value: 'dystonicMovements',
    },
    {
        label: 'Spasmodic Torticollis',
        value: 'spasmodicTorticollis',
    },
    {
        label: 'Hemiballismus',
        value: 'hemiballismus',
...
class Involuntary_Movement extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                examination_data: [
                    {
                        ...
                        question: 'involuntary_Movement',
                        other_answers: {
                            involuntary_Movement: 'no',
                            tremors: 'no',
                            choreiform: false,
                            myoclonus: false,
                            athetoidApasms: false,
                            dystonicMovements: false,
                            spasmodicTorticollis: false,
                            hemiballismus: false,
                        },
                    },
                ],
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log(
                'Examination Data Involuntary Movement',
                res.data.view.data
            )
            this.setState({ data: [] })
            let data = []
                ...
                >
                    <Grid container spacing={1}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Involuntary Movement" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.involuntary_Movement
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.involuntary_Movement =
                                            'no'
                        ...
                        {this.state.formData.examination_data[0].other_answers
                            ...
                            <Grid
                                ...
                                xs={12}
                            >
                                <SubTitle title="Tremors" />
                                <RadioGroup
                                    defaultValue={
                                        this.state.formData.examination_data[0]
                                            .other_answers.tremors
                                    }
                                    row
                                >
                                    <FormControlLabel
                                        ...
                                        onChange={() => {
                                            let formData = this.state.formData
                                            formData.examination_data[0].other_answers.tremors =
                                                'no'
                                            this.setState({ formData })
                                        }}
                                        control={
...
export default withStyles(styleSheet)(Involuntary_Movement)
