...
class Cyanosis extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log('Examination Data Cyanosis', res.data.view.data)
            this.setState({ data: [] })
            let data = []
            let other_answers = []
                ...
                >
                    <Grid container spacing={1}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Cyanosis" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.cyanosis
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.cyanosis =
                                            'no'
...
export default withStyles(styleSheet)(Cyanosis)
