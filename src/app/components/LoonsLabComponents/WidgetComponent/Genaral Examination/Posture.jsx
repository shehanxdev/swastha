                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.posture =
                                            'normal'
                        ...
                        {this.state.formData.examination_data[0].other_answers
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.parkinsonismPosture =
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.decorticateRigidity =
                                            !formData.examination_data[0]
                                                .other_answers
                                                .decorticateRigidity
                                        this.setState({ formData })
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.derebrateRigidity =
                                            !formData.examination_data[0]
                                                .other_answers.derebrateRigidity
                                        this.setState({ formData })
                                    }}
                                    defaultValue="normal"
                                    control={
