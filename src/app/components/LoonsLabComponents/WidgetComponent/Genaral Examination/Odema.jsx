...
class Odema extends Component {
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log('Examination Data Odema', res.data.view.data)
            this.setState({ data: [] })
            let data = []
            let other_answers = []
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.odema =
                                            'no'
...
export default withStyles(styleSheet)(Odema)
