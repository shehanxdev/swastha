...
class Mouth extends Component {
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log('Examination Data Mouth', res.data.view.data)
            this.setState({ data: [] })
            let data = []
            let other_answers = []
                ...
                >
                    <Grid container spacing={1}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Oral Hygiene" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.oralHygiene
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.oralHygiene =
                                            'good'
                        ...
                        {/* Dental Caries */}
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Dental Caries" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.dentalCaries
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.dentalCaries =
                                            'no'
                                        this.setState({ formData })
                                    }}
                                    control={
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <FormControlLabel
                                ...
                                onChange={() => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.cheilosis = true
                                    this.setState({ formData })
                                }}
                                defaultValue="normal"
                                control={
                            ...
                            <FormControlLabel
                                // key={i}
                                label="Angular Stomatitis"
                                name="angularStomatitis"
                                value="angularStomatitis"
                                onChange={() => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.angularStomatitis = true
                                    this.setState({ formData })
                                }}
                                defaultValue="normal"
                                control={
...
export default withStyles(styleSheet)(Mouth)
