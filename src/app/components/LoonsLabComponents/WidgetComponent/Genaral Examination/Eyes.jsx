...
class Eyes extends Component {
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log('Examination Data Eyes', res.data.view.data)
            this.setState({ data: [] })
            let data = []
            let other_answers = []
                    ...
                    <Grid container spacing={1}>
                        ...
                        {this.state.formData.examination_data[0].other_answers
                            ...
                            <Grid
                                ...
                                xs={12}
                            >
                                <SubTitle title="Icterus" />
                                <RadioGroup
                                    defaultValue={
                                        this.state.formData.examination_data[0]
                                            .other_answers.icterus
                                    }
                                    row
                                >
                                    <FormControlLabel
                                        ...
                                        onChange={() => {
                                            let formData = this.state.formData
                                            formData.examination_data[0].other_answers.icterus =
                                                'no'
                                            this.setState({ formData })
                                        }}
                                        control={
                        ...
                        {this.state.formData.examination_data[0].other_answers
                            ...
                            <Grid
                                ...
                                xs={12}
                            >
                                <SubTitle title="Pallore" />
                                <RadioGroup
                                    defaultValue={
                                        this.state.formData.examination_data[0]
                                            .other_answers.pallore
                                    }
                                    row
                                >
                                    <FormControlLabel
                                        ...
                                        onChange={() => {
                                            let formData = this.state.formData
                                            formData.examination_data[0].other_answers.pallore =
                                                'no'
                                            this.setState({ formData })
                                        }}
                                        control={
...
export default withStyles(styleSheet)(Eyes)
