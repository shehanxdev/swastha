                ...
                <ValidatorForm onSubmit={() => { this.submit() }} className='flex mx-2' >
                    <Grid container spacing={1}>
                        ...
                        <Grid className='' item lg={6} md={6} sm={12} xs={12}>
                            <SubTitle title='Apex' />
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.apex} row>
                                <FormControlLabel
                                    label={"Normal"}
                                    name="normal"
                                    value="normal"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.apex = "normal"
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.apex = "displaced"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        <Grid className='' item lg={6} md={6} sm={6} xs={12}>
                            <SubTitle title='Parasternal Heave' />
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.parasternalHeave} row>
                                <FormControlLabel
                                    label={"Yes"}
                                    name="yes"
                                    value="yes"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.parasternalHeave = "yes"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.parasternalHeave = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                        ...
                        {/* Trill */}
                        <Grid className='' item lg={6} md={6} sm={6} xs={12}>
                            <SubTitle title='Trill' />
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.trill} row>
                                <FormControlLabel
                                    label={"Systolic"}
                                    name="systolic"
                                    value="systolic"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.trill = "systolic"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.trill = "diastolic"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
...
export default withStyles(styleSheet)(Apex)
