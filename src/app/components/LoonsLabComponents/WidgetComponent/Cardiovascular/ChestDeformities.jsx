...
class ChestDeformities extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                <ValidatorForm onSubmit={() => { this.submit() }} className='flex mx-2' >
                    <Grid container spacing={1}>
                        ...
                        <Grid className='' item lg={12} md={12} sm={12} xs={12}>
                            ...
                            <RadioGroup defaultValue={this.state.formData.examination_data[0].other_answers.chestDeformities} row>
                                <FormControlLabel
                                    label={"Yes"}
                                    name="yes"
                                    value="yes"
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.chestDeformities = "yes"
                                ...
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData;
                                        formData.examination_data[0].other_answers.chestDeformities = "no"
                                        this.setState({ formData })
                                    }}
                                    control={
                                        <Radio size='small' color="primary" />
...
export default withStyles(styleSheet)(ChestDeformities)
