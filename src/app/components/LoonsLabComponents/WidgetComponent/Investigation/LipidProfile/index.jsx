                            ...
                            return (
                                <TextValidator
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (rowValue.test_name == "Total Cholesterol" || rowValue.test_name == "HDL") {
                                            if (formData.examination_data[0].other_answers["Total Cholesterol"].value != null && formData.examination_data[0].other_answers["HDL"].value != null) {
                                                formData.examination_data[0].other_answers["Chol/HDL"].value = parseFloat(formData.examination_data[0].other_answers["Total Cholesterol"].value) / parseFloat(formData.examination_data[0].other_answers["HDL"].value)
                                            }
                                        }
