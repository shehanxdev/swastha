...
class RespiratoryRate extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                >
                    <Grid container spacing={2}>
                        <Grid className="" item lg={12} md={6} sm={6} xs={6}>
                            <SubTitle title="Respiratory Rate" />
                            <TextValidator
                                ...
                                onChange={(e) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.respiratory_rate =
                                        e.target.value
                                ...
                                value={
                                    this.state.formData.examination_data[0]
                                        .other_answers.respiratory_rate
                                }
                                InputProps={{
                                    endAdornment: (
...
export default withStyles(styleSheet)(RespiratoryRate)
