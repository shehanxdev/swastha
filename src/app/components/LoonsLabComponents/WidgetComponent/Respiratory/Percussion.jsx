                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.percussion =
                                            'normal'
                                ...
                                <FormControlLabel
                                    label={'Hyper Resonant'}
                                    name="hyper_resonant"
                                    value="hyper_resonant"
                                    size="small"
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.percussion =
...
export default withStyles(styleSheet)(Percussion)
