...
class BreathSounds extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Breath Sounds" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.breath_sounds
                                }
                                row
                            >
                                <FormControlLabel
                                    label={'Vascular Breathing'}
                                    name="vascular_breathing"
                                    value="vascular_breathing"
                                    size="small"
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.breath_sounds =
                                            'vascular_breathing'
                                ...
                                <FormControlLabel
                                    ...
                                    name="bronchial_breathing"
                                    value="bronchial_breathing"
                                    size="small"
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.breath_sounds =
                        ...
                        {this.state.formData.examination_data[0].other_answers
                            .breath_sounds === 'vascular_breathing' ? (
                            <Grid
                                className=""
                                item
                                lg={12}
                            ...
                            >
                                <RadioGroup row>
                                    <FormControlLabel
                                        ...
                                        onChange={() => {
                                            let formData = this.state.formData
                                            formData.examination_data[0].other_answers.if_vascular_breathing =
                                                'normal'
                                            this.setState({ formData })
                                        }}
                                        control={<Radio color="primary" />}
                        ...
                        {this.state.formData.examination_data[0].other_answers
                            .if_vascular_breathing === 'diminished' ? (
                            <Grid
                                className=""
                                item
                                lg={12}
                            ...
                            >
                                ...
                                {checkbox_data.map((data) => (
                                    <FormControlLabel
                                        ...
                                        onChange={() => {
                                            let formData = this.state.formData
                                            formData.examination_data[0].other_answers.rightData =
                                                data.value
                                            this.setState({ formData })
                                        }}
                                        //defaultValue = 'normal'
                            ...
                            >
                                {checkbox_data.map((data) => (
                                    <FormControlLabel
                                        ...
                                        onChange={() => {
                                            let formData = this.state.formData
                                            formData.examination_data[0].other_answers.leftData =
                                                data.value
                                            this.setState({ formData })
                                        }}
                                        //defaultValue = 'normal'
...
export default withStyles(styleSheet)(BreathSounds)
