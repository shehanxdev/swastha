...
class AddedSounds extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Added Sounds" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.added_sounds
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.added_sounds =
                                            'rhonchi'
...
export default withStyles(styleSheet)(AddedSounds)
