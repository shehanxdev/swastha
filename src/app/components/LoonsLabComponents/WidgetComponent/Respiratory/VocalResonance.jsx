...
class VocalResonance extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Vocal Resonance" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.vocal_resonance
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.vocal_resonance =
                                            'normal'
                                ...
                                />
                                <FormControlLabel
                                    label={'Whispering Pectoriloquy'}
                                    name="whispering_pectoriloquy"
                                    value="whispering_pectoriloquy"
                                    size="small"
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.vocal_resonance =
                                            'whispering_pectoriloquy'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                                    display="inline"
...
export default withStyles(styleSheet)(VocalResonance)
