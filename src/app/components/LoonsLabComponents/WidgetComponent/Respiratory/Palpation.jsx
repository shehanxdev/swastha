...
class Palpation extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log('Examination Data Palpation', res.data.view.data)
            this.setState({ data: [] })
            let data = []
            let other_answers = []
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Trachea" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.trachea
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.trachea =
                                            'midline'
                                ...
                                <FormControlLabel
                                    label={'Deviated to Right Side'}
                                    name="deviated_to_right_side"
                                    value="deviated_to_right_side"
                                    size="small"
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.trachea =
                                            'deviated_to_right_side'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                                    display="inline"
                                ...
                                />
                                <FormControlLabel
                                    label={'Deviated to Left Side'}
                                    name="deviated_to_left_side"
                                    value="deviated_to_left_side"
                                    size="small"
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.trachea =
                                            'deviated_to_left_side'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                                    display="inline"
                        ...
                        <Grid className="" item lg={12} md={12} sm={6} xs={12}>
                            <SubTitle title=" Vocal Fremitus" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.vocal_fremitus
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.vocal_fremitus =
                                            'normal'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
...
export default withStyles(styleSheet)(Palpation)
