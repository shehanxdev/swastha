    ...
    async loadData() {
        ...
        if (200 == res.status) {
            ...
            res.data.view.data.forEach(element => {
                if (element.question == 'complications') {
                    ...
                    <div className='w-full'>
                        <ValidatorForm onSubmit={() => { this.submit() }} className='w-full'>
                                ...
                                <Grid item lg={12} md={12} sm={12} xs={12} className='hide-on-fullScreen' >
                                    ...
                                    <TextValidator
                                        ...
                                        onChange={(e) => {
                                            ...
                                            let formData = this.state.formData;
                                            formData.examination_data[0].other_answers.complication = e.target.value
                                            this.setState({ formData })


                                        }}
                                        value={this.state.formData.examination_data[0].other_answers.complication}
                            ...
                            <Grid container>
                                ...
                                <Grid className='show-on-fullScreen px-5' item lg={12} md={12} sm={12} xs={12}>
                                ...
                                > */}
                                    ...
                                    <Grid className='mt-3 ' container spacing={2} >
                                        <Grid item lg={12} md={12} sm={12} xs={12}>
                                        <Typography variant="h6" style={{ fontSize: 16, color: 'black' }}>Add New Complication</Typography>
...
export default withStyles(styleSheet)(Complications)
