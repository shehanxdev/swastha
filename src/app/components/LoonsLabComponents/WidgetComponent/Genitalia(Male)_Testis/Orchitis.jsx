...
class Orchitis extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
    ...
    async loadData() {
        ...
        if (200 == res.status) {
            console.log("Examination Data Orchitis", res.data.view.data)
            this.setState({ data: [] })
            let data = [];
            let other_answers = [];
...
export default withStyles(styleSheet)(Orchitis)
