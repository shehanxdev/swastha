...
class Hepatomegaly extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
            ...
            <Fragment>
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        {/* Hepatomegaly */}
                        <Grid className="" item lg={8} md={12} sm={12} xs={12}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.margin =
                                            'regular'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            ...
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.consistency =
                                            'soft'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
                                    ...
                                    >
                                        <FormControlLabel
                                            ...
                                            onChange={() => {
                                                let formData =
                                                    this.state.formData
                                                formData.examination_data[0].other_answers.surface =
                                                    'smooth'
                                                this.setState({ formData })
                                            }}
                                            control={<Radio color="primary" />}
                                ...
                                <Grid
                                    ...
                                    xs={12}
                                >
                                    <SubTitle title="Hepatic Bruits" />
                                    <RadioGroup
                                        defaultValue={
                                            this.state.formData
                                                .examination_data[0]
                                                .other_answers.hepatic_bruits
                                        }
                                        row
                                    >
                                        <FormControlLabel
                                            ...
                                            onChange={() => {
                                                let formData =
                                                    this.state.formData
                                                formData.examination_data[0].other_answers.hepatic_bruits =
                                                    'yes'
                                                this.setState({ formData })
                                            }}
                                            control={<Radio color="primary" />}
...
export default withStyles(styleSheet)(Hepatomegaly)
