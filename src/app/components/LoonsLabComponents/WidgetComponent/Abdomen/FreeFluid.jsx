...
class FreeFluid extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alert: false,
                ...
                examination_data: [
                    {
                        ...
                        question: 'free_fluid',
                        other_answers: {
                            ascites: 'gross_ascites',
                            tenderness: 'no',
                            shifting_dullness: 'no',
                            comment: null,
                        },
                    },
                ],
                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Ascites" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.ascites
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.ascites =
                                            'gross_ascites'
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Shifting Dullness" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.shifting_dullness
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.shifting_dullness =
                                            'no'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
...
export default withStyles(styleSheet)(FreeFluid)
