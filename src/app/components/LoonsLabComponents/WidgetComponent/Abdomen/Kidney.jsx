                ...
                >
                    <Grid container spacing={2}>
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Ballotable Kidney" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.ballotable_kidney
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.ballotable_kidney =
                                            'yes'
                        ...
                        <Grid className="" item lg={12} md={12} sm={12} xs={12}>
                            <SubTitle title="Renal Bruit" />
                            <RadioGroup
                                defaultValue={
                                    this.state.formData.examination_data[0]
                                        .other_answers.renal_bruit
                                }
                                row
                            >
                                <FormControlLabel
                                    ...
                                    onChange={() => {
                                        let formData = this.state.formData
                                        formData.examination_data[0].other_answers.renal_bruit =
                                            'yes'
                                        this.setState({ formData })
                                    }}
                                    control={<Radio color="primary" />}
...
export default withStyles(styleSheet)(Kidney)
