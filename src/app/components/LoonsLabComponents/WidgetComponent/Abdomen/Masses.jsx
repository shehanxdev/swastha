                    ...
                    <Grid container spacing={2} className="">
                        ...
                        <Grid className="" item lg={6} md={12} sm={12} xs={12}>
                            ...
                            <TextValidator
                                ...
                                onChange={(e) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.abdominal_size =
                                        e.target.value
                                    this.setState({
                                        formData,
                                    })
                    ...
                    <Grid container spacing={2} className="space-between ">
                        ...
                        >
                            ...
                            <TextValidator
                                ...
                                onChange={(e) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.renal_size =
                                        e.target.value
                        ...
                        >
                            ...
                            <TextValidator
                                ...
                                onChange={(e) => {
                                    let formData = this.state.formData
                                    formData.examination_data[0].other_answers.pelvic_size =
                                        e.target.value
...
export default withStyles(styleSheet)(Masses)
