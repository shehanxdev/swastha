...
const Layout1 = () => {
    ...
    return (
        <div className={clsx('bg-default', layoutClasses)}>
            <div id="app-fullscreen-1856" className="px-5 py-5"></div>
            ...
            >
                {layout1Settings.topbar.show &&
                    layout1Settings.topbar.fixed && (
                        <ThemeProvider theme={topbarTheme}></ThemeProvider>
                    )}
                ...
                {settings.perfectScrollbar && (
                    <Scrollbar className="flex-grow flex-column relative h-full">
                        ...
                        <div id="home123" className="relative flex-grow">
                ...
                {!settings.perfectScrollbar && (
                    <div className="flex-grow flex-column relative h-full scroll-y">
                        ...
                        <div id="home123" className="relative flex-grow">
                            <Tooltip
                                className="show-on-appfullScreen"
                            ...
                            <strong>Important ! Swastha system will be unavailable on 2023/11/19 from 1.00 a.m to 6.00 a.m due to a system upgrade.</strong>
                        </Alert> */}
